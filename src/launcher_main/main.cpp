...
static const AppId_t k_unSDK2013MPAppId = 5147380;
...
static bool GetGameInstallDir( const char *pRootDir, char *pszBuf, int nBufSize, bool bDedicated )
{
	...
	if ( unLength == 0 )
	{
		if ( bDedicated )
		{
			...
			MessageBox( 0, "Team Fortress 2 (440) and Team Frontress (5147380 or 5147380) must be installed to launch this mod.", "Launcher Error", MB_OK );
#else
