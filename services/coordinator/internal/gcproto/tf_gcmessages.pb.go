...
const (
	ETFGCMsg_k_EMsgGCReportWarKill                               ETFGCMsg = 5001 //War kill tracking. No longer in use
	ETFGCMsg_k_EMsgGCKickPlayer_DEPRECATED                       ETFGCMsg = 5020 // GC => game server & client
	ETFGCMsg_k_EMsgGCStartedTraining_DEPRECATED                  ETFGCMsg = 5021 // client => GC
	ETFGCMsg_k_EMsgGCFreeTrial_ChooseMostHelpfulFriend           ETFGCMsg = 5022 // client => GC
	ETFGCMsg_k_EMsgGCRequestTF2Friends                           ETFGCMsg = 5023 // client => GC
	ETFGCMsg_k_EMsgGCRequestTF2FriendsResponse                   ETFGCMsg = 5024 // GC => client
	ETFGCMsg_k_EMsgGCReplay_SubmitContestEntry                   ETFGCMsg = 5026 // client => GC
	ETFGCMsg_k_EMsgGCReplay_SubmitContestEntryResponse           ETFGCMsg = 5027 // client => GC
	ETFGCMsg_k_EMsgGCSaxxy_Awarded                               ETFGCMsg = 5029 // GC => client
	ETFGCMsg_k_EMsgGCFreeTrial_ThankedBySomeone                  ETFGCMsg = 5028 // GC => client
	ETFGCMsg_k_EMsgGCFreeTrial_ThankedSomeone                    ETFGCMsg = 5030 // GC => client
	ETFGCMsg_k_EMsgGCFreeTrial_ConvertedToPremium                ETFGCMsg = 5031 // GC => client
	ETFGCMsg_k_EMsgGCMeetThePyroSilliness_BananaCraft_DEPRECATED ETFGCMsg = 5032 // GC => client (was part of the pre-Meet-the-Pyro silliness)
	ETFGCMsg_k_EMsgGCMVMARG_HighFiveSuccessResponse_DEPRECATED   ETFGCMsg = 5033 // GC => client (was part of the pre-MVM silliness)
	ETFGCMsg_k_EMsgGCMVMARG_HighFiveOnClient_DEPRECATED          ETFGCMsg = 5034 // client => GC (was part of the pre-MVM silliness)
	// Coaching
	ETFGCMsg_k_EMsgGCCoaching_AddToCoaches              ETFGCMsg = 5200 // client is requesting that they be added to a list of eligible coaches
	ETFGCMsg_k_EMsgGCCoaching_AddToCoachesResponse      ETFGCMsg = 5201
	ETFGCMsg_k_EMsgGCCoaching_RemoveFromCoaches         ETFGCMsg = 5202 // client is requesting to be removed from list of eligible coaches
	ETFGCMsg_k_EMsgGCCoaching_RemoveFromCoachesResponse ETFGCMsg = 5203 // sent by GC to client
	ETFGCMsg_k_EMsgGCCoaching_FindCoach                 ETFGCMsg = 5204 // sent by client to GC requesting a coach be found
	ETFGCMsg_k_EMsgGCCoaching_FindCoachResponse         ETFGCMsg = 5205 // sent by GC to client looking for a coach
	ETFGCMsg_k_EMsgGCCoaching_AskCoach                  ETFGCMsg = 5206 // sent by GC to coach asking if they want to coach a student
	ETFGCMsg_k_EMsgGCCoaching_AskCoachResponse          ETFGCMsg = 5207 // (coach) client's response to whether they want to coach the found student
	ETFGCMsg_k_EMsgGCCoaching_CoachJoinGame             ETFGCMsg = 5208 // sent by GC to (coach) client to tell them to join the server
	ETFGCMsg_k_EMsgGCCoaching_CoachJoining              ETFGCMsg = 5209 // sent by GC to game session to tell them who is going to coach whom
	ETFGCMsg_k_EMsgGCCoaching_CoachJoined               ETFGCMsg = 5210 // sent by GC to game server letting them know a coach has joined
	ETFGCMsg_k_EMsgGCCoaching_LikeCurrentCoach          ETFGCMsg = 5211 // sent by (student) client to GC to indicate that they like their coach
	ETFGCMsg_k_EMsgGCCoaching_RemoveCurrentCoach        ETFGCMsg = 5212 // sent by (student) client to GC to indicate that they want to get rid of their coach, and eventually to game server
	ETFGCMsg_k_EMsgGCCoaching_AlreadyRatedCoach         ETFGCMsg = 5213 // sent by GC to (student) client
	// mini-games:
	// duel
	ETFGCMsg_k_EMsgGC_Duel_Request  ETFGCMsg = 5500 // GC => target (all clients?)
	ETFGCMsg_k_EMsgGC_Duel_Response ETFGCMsg = 5501 // challenged client => GC and GC => all clients
	ETFGCMsg_k_EMsgGC_Duel_Results  ETFGCMsg = 5502 // gameserver => GC
	ETFGCMsg_k_EMsgGC_Duel_Status   ETFGCMsg = 5503 // GC => client
	// halloween (deprecated GCMsg types)
	ETFGCMsg_k_EMsgGC_Halloween_ReservedItem_DEPRECATED        ETFGCMsg = 5600 // GC => clients
	ETFGCMsg_k_EMsgGC_Halloween_GrantItem_DEPRECATED           ETFGCMsg = 5601 // client(s) => GC
	ETFGCMsg_k_EMsgGC_Halloween_GrantItemResponse_DEPRECATED   ETFGCMsg = 5604 // GC => client(s)
	ETFGCMsg_k_EMsgGC_Halloween_Cheat_QueryResponse_DEPRECATED ETFGCMsg = 5605 // clients => GC
	ETFGCMsg_k_EMsgGC_Halloween_ItemClaimed_DEPRECATED         ETFGCMsg = 5606 // GC => clients
	// Halloween (new CProtoBufMsg types)
	ETFGCMsg_k_EMsgGC_Halloween_ReservedItem                     ETFGCMsg = 5607 // GC => clients
	ETFGCMsg_k_EMsgGC_Halloween_GrantItem                        ETFGCMsg = 5608 // client(s) => GC
	ETFGCMsg_k_EMsgGC_Halloween_GrantItemResponse                ETFGCMsg = 5609 // GC => client(s)
	ETFGCMsg_k_EMsgGC_Halloween_Cheat_QueryResponse_DEPRECATED_2 ETFGCMsg = 5610 // clients => GC
	ETFGCMsg_k_EMsgGC_Halloween_ItemClaimed_DEPRECATED_2         ETFGCMsg = 5611 // GC => clients
	ETFGCMsg_k_EMsgGC_Halloween_ServerBossEvent                  ETFGCMsg = 5612 // server => GC
	ETFGCMsg_k_EMsgGC_Halloween_Merasmus2012                     ETFGCMsg = 5613 // server => GC
	ETFGCMsg_k_EMsgGC_Halloween_UpdateMerasmusLootLevel          ETFGCMsg = 5614 // Client => GC
	// Game Server stuff
	ETFGCMsg_k_EMsgGC_GameServer_LevelInfo              ETFGCMsg = 5700 // game server => GC
	ETFGCMsg_k_EMsgGC_GameServer_AuthChallenge          ETFGCMsg = 5701 // GC => game server
	ETFGCMsg_k_EMsgGC_GameServer_AuthChallengeResponse  ETFGCMsg = 5702 // game server => GC
	ETFGCMsg_k_EMsgGC_GameServer_CreateIdentity         ETFGCMsg = 5703 // client => GC
	ETFGCMsg_k_EMsgGC_GameServer_CreateIdentityResponse ETFGCMsg = 5704 // GC => client
	ETFGCMsg_k_EMsgGC_GameServer_List                   ETFGCMsg = 5705 // client => GC
	ETFGCMsg_k_EMsgGC_GameServer_ListResponse           ETFGCMsg = 5706 // GC => client
	ETFGCMsg_k_EMsgGC_GameServer_AuthResult             ETFGCMsg = 5707 // GC => client
	ETFGCMsg_k_EMsgGC_GameServer_ResetIdentity          ETFGCMsg = 5708 // GC => client
	ETFGCMsg_k_EMsgGC_GameServer_ResetIdentityResponse  ETFGCMsg = 5709 // GC => client
	// Game-server-modifying client items
	ETFGCMsg_k_EMsgGC_Client_UseServerModificationItem              ETFGCMsg = 5710 // client => GC
	ETFGCMsg_k_EMsgGC_Client_UseServerModificationItem_Response     ETFGCMsg = 5711 // GC => client
	ETFGCMsg_k_EMsgGC_GameServer_UseServerModificationItem          ETFGCMsg = 5712 // GC => game server
	ETFGCMsg_k_EMsgGC_GameServer_UseServerModificationItem_Response ETFGCMsg = 5713 // game server => GC
	ETFGCMsg_k_EMsgGC_GameServer_ServerModificationItemExpired      ETFGCMsg = 5714 // game server => GC
	ETFGCMsg_k_EMsgGC_GameServer_ModificationItemState              ETFGCMsg = 5715 // GC => game server
	ETFGCMsg_k_EMsgGC_GameServer_AckPolicy                          ETFGCMsg = 5716 // client => GC
	ETFGCMsg_k_EMsgGC_GameServer_AckPolicyResponse                  ETFGCMsg = 5717 // GC => client
	// Quickplay
	ETFGCMsg_k_EMsgGC_QP_ScoreServers         ETFGCMsg = 5800 // client => GC
	ETFGCMsg_k_EMsgGC_QP_ScoreServersResponse ETFGCMsg = 5801 // client => GC
	ETFGCMsg_k_EMsgGC_QP_PlayerJoining        ETFGCMsg = 5802 // GC => server
	// Cheat challenge (deperecated GCMsg types)
	ETFGCMsg_k_EMsgGC_PickupItemEligibility_Query_DEPRECATED ETFGCMsg = 6000 // GC => clients
	// Cheat challenge (new CProtoBufMsg types)
	ETFGCMsg_k_EMsgGC_PickupItemEligibility_Query_DEPRECATED_2 ETFGCMsg = 6001 // GC => clients
	// Leveling Weapons
	ETFGCMsg_k_EMsgGC_IncrementKillCountAttribute_DEPRECATED ETFGCMsg = 6100 // client => GC (a player killed) (deprecated: moved to econ)
	ETFGCMsg_k_EMsgGC_IncrementKillCountResponse_DEPRECATED  ETFGCMsg = 6101 // GC => client (deprecated: moved to econ)
	// Coop matchmaking
	//
	...
	ETFGCMsg_k_EMsgGCReadyUp                        ETFGCMsg = 6270 // sent to acknowledge lobby readiness
	ETFGCMsg_k_EMsgGCKickedFromMatchmakingQueue     ETFGCMsg = 6271 // player has been removed from the matchmaking queue (for not readying up)
	ETFGCMsg_k_EMsgGCLeaverDetected                 ETFGCMsg = 6272 // sent from server to GC when a player has been AFK/disconnected too long
	...
	ETFGCMsg_k_EMsgGCMvMVictory                  ETFGCMsg = 6297 // game server -> GC, report MvM Victory
	ETFGCMsg_k_EMsgGCMvMVictoryReply             ETFGCMsg = 6298 // GC -> game server, acknowledge of recieving MvM Victory
	ETFGCMsg_k_EMsgGCGameServerKickingLobby      ETFGCMsg = 6299 // Game server is finished running match, please destroy lobby.
	// Reply message added later as 6521
	ETFGCMsg_k_EMsgGCLeaveGameAndPrepareToJoinParty ETFGCMsg = 6300 // GC -> client.  Disconnect from the server and go to the lobby UI; I'm putting you in a party
	...
	ETFGCMsg_k_EMsgGC_UpdatePeriodicEvent                   ETFGCMsg = 6400 // game server => GC
	ETFGCMsg_k_EMsgGC_DuckLeaderboard_IndividualUpdate      ETFGCMsg = 6401 // Client -> GC
	...
	ETFGCMsg_k_EMsgGC_ClientVerificationChallenge           ETFGCMsg = 6500 // GC -> client
	ETFGCMsg_k_EMsgGC_ClientVerificationChallengeResponse   ETFGCMsg = 6501 // client -> GC
	ETFGCMsg_k_EMsgGC_ClientVerificationVerboseResponse     ETFGCMsg = 6502 // client -> GC
	ETFGCMsg_k_EMsgGC_ClientSetItemSlotAttribute            ETFGCMsg = 6503 // client -> GC
	ETFGCMsg_k_EMsgGC_War_IndividualUpdate                  ETFGCMsg = 6505 // game server -> GC
	ETFGCMsg_k_EMsgGC_War_JoinWar                           ETFGCMsg = 6506 // client -> GC
	ETFGCMsg_k_EMsgGC_War_RequestGlobalStats                ETFGCMsg = 6507 // client -> GC
	ETFGCMsg_k_EMsgGC_War_GlobalStatsResponse               ETFGCMsg = 6508 // GC -> client
	ETFGCMsg_k_EMsgGC_WorldItemPlacement_Attribute          ETFGCMsg = 6510 //
	ETFGCMsg_k_EMsgGC_WorldItemPlacement_Update             ETFGCMsg = 6511 // client -> GC
	ETFGCMsg_k_EMsgGC_Match_Result                          ETFGCMsg = 6512 // game server -> GC. Response message added later as 6520 below
	ETFGCMsg_k_EMsgGCVoteKickPlayerRequest                  ETFGCMsg = 6513 // game server -> GC
	ETFGCMsg_k_EMsgGCVoteKickPlayerRequestResponse          ETFGCMsg = 6514 // GC -> game server
	ETFGCMsg_k_EMsgGC_DailyCompetitiveStatsRollup           ETFGCMsg = 6516 // game server -> GC
	ETFGCMsg_k_EMsgGC_DailyCompetitiveStatsRollup_Response  ETFGCMsg = 6517 // GC -> game server
	ETFGCMsg_k_EMsgGC_WorldStatusBroadcast                  ETFGCMsg = 6518 // GC -> client
	ETFGCMsg_k_EMsgGC_ReportPlayer                          ETFGCMsg = 6519 // client -> GC
	ETFGCMsg_k_EMsgGC_Match_ResultResponse                  ETFGCMsg = 6520 // GC -> game server. Response message for 6512 above
	ETFGCMsg_k_EMsgGCGameServerKickingLobbyResponse         ETFGCMsg = 6521 // GC -> game server. Response message for 6299 above
	ETFGCMsg_k_EMsgGCPlayerLeftMatch                        ETFGCMsg = 6522 // game server -> GC, a player left this match
	ETFGCMsg_k_EMsgGCPlayerLeftMatchResponse                ETFGCMsg = 6523 // GC -> game server. Response message for above
	ETFGCMsg_k_EMsgGCRequestMatchMakerStats                 ETFGCMsg = 6524 // Client -> GC. Request for the below message
	ETFGCMsg_k_EMsgGCMatchMakerStatsResponse                ETFGCMsg = 6525 // GC -> Client.  Response to above message
	ETFGCMsg_k_EMsgGCMatchHistoryLoad                       ETFGCMsg = 6526 // Client -> GC.
	ETFGCMsg_k_EMsgGC_AcknowledgeXP                         ETFGCMsg = 6527 // Client -> GC. Acknowledge pending XP
	ETFGCMsg_k_EMsgGCDataCenterPing_Update                  ETFGCMsg = 6528 // client -> GC.
	ETFGCMsg_k_EMsgGC_NotificationAcknowledge               ETFGCMsg = 6529 // Client -> GC.  Acknowledge notifications
	ETFGCMsg_k_EMsgGC_NotificationAcknowledgeReply          ETFGCMsg = 6530 // GC -> Client.  Let client know if we've received the acknowledgement
	ETFGCMsg_k_EMsgGC_KickPlayerFromLobby                   ETFGCMsg = 6531 // GC -> game server. Tell the server to kick a player
	ETFGCMsg_k_EMsgGC_SurveyQuestionRequest                 ETFGCMsg = 6534 // GC -> Client.  Ask the client to fill out a survey
	ETFGCMsg_k_EMsgGC_SurveyQuestionResponse                ETFGCMsg = 6535 // Client -> GC.  Client response to the request
	ETFGCMsg_k_EMsgGC_TFClientInit                          ETFGCMsg = 6536 // Client -> GC. Clients send this in response to
	ETFGCMsg_k_EMsgGC_NewMatchForLobbyRequest               ETFGCMsg = 6537 // Game server -> GC.
	ETFGCMsg_k_EMsgGC_NewMatchForLobbyResponse              ETFGCMsg = 6538 // GC -> Game server
	ETFGCMsg_k_EMsgGC_ChangeMatchPlayerTeamsRequest         ETFGCMsg = 6539 // Game server -> GC.
	ETFGCMsg_k_EMsgGC_ChangeMatchPlayerTeamsResponse        ETFGCMsg = 6540 // GC -> Game server
	ETFGCMsg_k_EMsgGC_QuestIdentify                         ETFGCMsg = 6541 // Client -> GC. Identify a quest
	ETFGCMsg_k_EMsgGC_QuestDevGive                          ETFGCMsg = 6542 // Client -> GC. Request a quest
	ETFGCMsg_k_EMsgGCQuestComplete_Debug                    ETFGCMsg = 6544 // Client -> GC.  Make progress on, and complete a quest
	ETFGCMsg_k_EMsgGC_QuestMapDebug                         ETFGCMsg = 6545 // Client -> GC.  Debug commands from the client
	ETFGCMsg_k_EMsgGC_QuestMapUnlockNode                    ETFGCMsg = 6547 // Client -> GC.  Activates a node.  Does the unlock if necessary.
	ETFGCMsg_k_EMsgGC_QuestMapPurchaseReward                ETFGCMsg = 6549 // Client -> GC.	Purchase a reward item using CYOA Cash
	ETFGCMsg_k_EMsgGC_SetDisablePartyQuestProgress          ETFGCMsg = 6550 // Client -> GC.	Set whether the user would like to allow party members to make progress.  Flips a bit on their account.
	ETFGCMsg_k_EMsgGCQuestProgressReport                    ETFGCMsg = 6553 // GC -> Client.  Tell a client what great stuff just happened with their quest
	// Upgraded party system messages, replacing CreateOrUpdateParty. Reliable.
	ETFGCMsg_k_EMsgGCParty_SetOptions              ETFGCMsg = 6554 // Client -> GC.  Update a party's criteria/settings. Reliable.
	ETFGCMsg_k_EMsgGCParty_SetOptionsResponse      ETFGCMsg = 6555 // GC -> Client.  Reliable message response.
	ETFGCMsg_k_EMsgGCParty_QueueForMatch           ETFGCMsg = 6556 // Client -> GC.  Request a party enter queue for MM. Reliable.
	ETFGCMsg_k_EMsgGCParty_QueueForMatchResponse   ETFGCMsg = 6557 // GC -> Client.  Reliable message response.
	ETFGCMsg_k_EMsgGCParty_RemoveFromQueue         ETFGCMsg = 6558 // Client -> GC.  Request a party leave queue for MM. Reliable.
	ETFGCMsg_k_EMsgGCParty_RemoveFromQueueResponse ETFGCMsg = 6559 // GC -> Client.  Reliable message response.
	...
	ETFGCMsg_k_EMsgGCParty_InvitePlayer                   ETFGCMsg = 6560 // Client -> GC.  Invite a player to our party
	ETFGCMsg_k_EMsgGCParty_RequestJoinPlayer              ETFGCMsg = 6561 // Client -> GC.  Request to join a player's current party
	ETFGCMsg_k_EMsgGCParty_SendChat                       ETFGCMsg = 6562 // Client -> GC.  Send a party chat message.
	ETFGCMsg_k_EMsgGCParty_ChatMsg                        ETFGCMsg = 6563 // GC -> Client.  Got a party chat message.
	ETFGCMsg_k_EMsgGCQuestNodeTurnIn                      ETFGCMsg = 6564 // Client -> GC.  Turn in a quest node and redeem loot.
	ETFGCMsg_k_EMsgGCConsumePaintKit                      ETFGCMsg = 6565 // Client -> GC.  Consume a paintkit and get a painted item
	ETFGCMsg_k_EMsgGC_Painkit_DevGrant                    ETFGCMsg = 6566 // Clinet -> GC.  Dev only.  Give ALL supported items of a specified paintkit.
	ETFGCMsg_k_EMsgGCParty_QueueForStandby                ETFGCMsg = 6567 // Client -> GC.  Request to be queued to join your party's lobby
	ETFGCMsg_k_EMsgGCParty_QueueForStandbyResponse        ETFGCMsg = 6568 // GC -> Client.  Reliable message response.
	ETFGCMsg_k_EMsgGCParty_RemoveFromStandbyQueue         ETFGCMsg = 6569 // Client -> GC.  Request to cancel standby queue
	ETFGCMsg_k_EMsgGCParty_RemoveFromStandbyQueueResponse ETFGCMsg = 6570 // GC -> Client.  Reliable message response.
	ETFGCMsg_k_EMsgGCParty_ClearPendingPlayer             ETFGCMsg = 6571 // Client -> GC.  Leader -- revoke/reject a invite/join request on the party
	ETFGCMsg_k_EMsgGCParty_ClearPendingPlayerResponse     ETFGCMsg = 6572 // GC -> Client.  Reliable message response.
	ETFGCMsg_k_EMsgGCParty_ClearOtherPartyRequest         ETFGCMsg = 6573 // Client -> GC.  Invitee -- Clear or reject an outgoing join request/incoming invite
	ETFGCMsg_k_EMsgGCParty_ClearOtherPartyRequestResponse ETFGCMsg = 6574 // GC -> Client.  Reliable message response.
	ETFGCMsg_k_EMsgGCParty_PromoteToLeader                ETFGCMsg = 6575 // Client -> GC.  Make another group member the leader
	ETFGCMsg_k_EMsgGCParty_KickMember                     ETFGCMsg = 6576 // Client -> GC.  Make another group member be not here
	ETFGCMsg_k_EMsgGCQuestStrangeEvent                    ETFGCMsg = 6577 // game server -> GC.  Record quest strange event
	ETFGCMsg_k_EMsgGC_AcceptLobbyInvite                   ETFGCMsg = 6578 // Client -> GC.  Accepts a lobby invite, joining the lobby
	ETFGCMsg_k_EMsgGC_AcceptLobbyInviteReply              ETFGCMsg = 6579 // GC -> Client.  Reliable message response.
	ETFGCMsg_k_EMsgGC_SDRTicket                           ETFGCMsg = 6580 // GC -> Client.  Hey, here's an SDR ticket.  You're probably about to need it
	ETFGCMsg_k_EMsgGC_ProcessMatchVoteKick                ETFGCMsg = 6581 // game server -> GC, players voted to kick someone
	ETFGCMsg_k_EMsgGC_ProcessMatchVoteKickResponse        ETFGCMsg = 6582 // GC -> game server. Response message for above
	ETFGCMsg_k_EMsgGCToGC_SendAccountBannedNotifications  ETFGCMsg = 6584 // GC->GC, via SQL message queue, send notifications to reporters that a user they reported was banned
	ETFGCMsg_k_EMsgGCToGC_SendNotification                ETFGCMsg = 6585 // GC->GC, via SQL message queue, send a notification.  Used for queuing multiple notifications transactionally without locking everyone involved.
	ETFGCMsg_k_EMsgGCParty_MMError                        ETFGCMsg = 6586 // GC -> client, feedback for when an MM error ends your queue/match/etc
	ETFGCMsg_k_EMsgGC_GameServer_UpdateData               ETFGCMsg = 6587 // game server -> GC, report server data (CMsgGameServerData)
	// Development only messages
	ETFGCMsg_k_EMsgGCDev_GrantWarKill ETFGCMsg = 10001 //War kill tracking. No longer in use
)
...
var (
	ETFGCMsg_name = map[int32]string{
		...
		6587:  "k_EMsgGC_GameServer_UpdateData",
	...
	ETFGCMsg_value = map[string]int32{
		...
		"k_EMsgGC_GameServer_UpdateData":                         6587,
...
const (
	...
	ETFMatchGroup_k_eTFMatchGroup_First        ETFMatchGroup = 0 // First valid group.
	ETFMatchGroup_k_eTFMatchGroup_MvM_Default  ETFMatchGroup = 0 // Default = Practice
	...
	ETFMatchGroup_k_eTFMatchGroup_Ladder_Default ETFMatchGroup = 2 // Default = 6v6
	...
	ETFMatchGroup_k_eTFMatchGroup_Casual_Default ETFMatchGroup = 7 // Default = 12v12
	...
	ETFMatchGroup_k_eTFMatchGroup_Event_Default     ETFMatchGroup = 8 // Default = Competitive 12v12
...
const (
	...
	TF_GC_GameState_TF_GC_GAMESTATE_LAST                     TF_GC_GameState = 8 // keep this as the last index
)
...
const (
	TF_GC_TEAM_TF_GC_TEAM_DEFENDERS   TF_GC_TEAM = 0 // Mann	(used as red in ladder games)
	TF_GC_TEAM_TF_GC_TEAM_INVADERS    TF_GC_TEAM = 1 // Machine	(used as blue in ladder games)
	TF_GC_TEAM_TF_GC_TEAM_BROADCASTER TF_GC_TEAM = 2
	TF_GC_TEAM_TF_GC_TEAM_SPECTATOR   TF_GC_TEAM = 3
	TF_GC_TEAM_TF_GC_TEAM_PLAYER_POOL TF_GC_TEAM = 4 // players that haven't been assign to a team yet
...
const (
	TFMatchLeaveReason_TFMatchLeaveReason_UNSPECIFIED TFMatchLeaveReason = 0 // No idea
	TFMatchLeaveReason_TFMatchLeaveReason_VOTE_KICK   TFMatchLeaveReason = 1 // Vote kicked by teammates
	TFMatchLeaveReason_TFMatchLeaveReason_IDLE        TFMatchLeaveReason = 2 // Idle kick
	TFMatchLeaveReason_TFMatchLeaveReason_ADMIN_KICK  TFMatchLeaveReason = 3 // Admin kick
	TFMatchLeaveReason_TFMatchLeaveReason_AWOL        TFMatchLeaveReason = 4 // Player left the match and did not return in time
	TFMatchLeaveReason_TFMatchLeaveReason_NO_SHOW     TFMatchLeaveReason = 5 // Player never showed up
	TFMatchLeaveReason_TFMatchLeaveReason_GC_REMOVED  TFMatchLeaveReason = 6 // Dropped via GC (e.g. refused to rejoin, removed themselves from the lobby, but wasn't clear to leave)
)
...
const (
	ServerMatchmakingState_ServerMatchmakingState_INVALID           ServerMatchmakingState = 0 // Dummy value used for sentinel / debugging
...
func (CMsgGC_GameServer_CreateIdentityResponse_EStatus) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{40, 0}
}
...
func (CMsgGC_Client_UseServerModificationItem_Response_EServerModificationItemResponse) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{48, 0}
}
...
func (CMsgGC_GameServer_UseServerModificationItem_Response_EServerModificationItemServerResponse) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{50, 0}
}
...
func (TFPendingPartyMember_EType) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{60, 0}
}
...
func (CMsgPartyMMError_Type) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{79, 0}
}
...
func (CSOTFPartyInvite_Type) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{88, 0}
}

type CTFLobbyPlayerProto_ConnectState int32

const (
	CTFLobbyPlayerProto_INVALID             CTFLobbyPlayerProto_ConnectState = 0 // Dummy / sentinel value used for debugging
	CTFLobbyPlayerProto_RESERVATION_PENDING CTFLobbyPlayerProto_ConnectState = 1 // GC is telling gameserver it wants to add a player, and is asking gameserver to acknowledge
	CTFLobbyPlayerProto_RESERVED            CTFLobbyPlayerProto_ConnectState = 2 // Gameserver has acknowledged reservation
	CTFLobbyPlayerProto_CONNECTED           CTFLobbyPlayerProto_ConnectState = 3 // Is currently connected (and joined through matchmaking)
	// CONNECTED_AD_HOC  = 4; // Connected ad-hoc.
	CTFLobbyPlayerProto_DISCONNECTED CTFLobbyPlayerProto_ConnectState = 5 // Connected at somepoint via match making but is no longer connected
)
...
func (CTFLobbyPlayerProto_ConnectState) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{89, 0}
}

type CTFLobbyPlayerProto_Type int32

const (
	CTFLobbyPlayerProto_INVALID_PLAYER   CTFLobbyPlayerProto_Type = 0 // Shouldn't happen
	CTFLobbyPlayerProto_MATCH_PLAYER     CTFLobbyPlayerProto_Type = 1 // Member of the match
	CTFLobbyPlayerProto_STANDBY_PLAYER   CTFLobbyPlayerProto_Type = 2 // On standby to join the match
	CTFLobbyPlayerProto_OBSERVING_PLAYER CTFLobbyPlayerProto_Type = 3 // Observing the match, not a part of it
)
...
func (CTFLobbyPlayerProto_Type) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{89, 1}
}
...
const (
	CSOTFGameServerLobby_UNKNOWN CSOTFGameServerLobby_State = 0 // Broken/bad lobby state. Lobbies can be in this state if we go down and restore from
	// memcache during their setup, for instance
	CSOTFGameServerLobby_SERVERSETUP CSOTFGameServerLobby_State = 1 // selecting a server and getting it ready
	CSOTFGameServerLobby_RUN         CSOTFGameServerLobby_State = 2 // server is ready, connect to it and play!
)
...
func (CSOTFGameServerLobby_State) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{91, 0}
}
...
func (CSOTFGameServerLobby_WarMatch) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{91, 1}
}

type CMsgGameServerMatchmakingStatus_PlayerConnectState int32

const (
	CMsgGameServerMatchmakingStatus_INVALID   CMsgGameServerMatchmakingStatus_PlayerConnectState = 0 // Dummy / sentinel value used for debugging
	CMsgGameServerMatchmakingStatus_CONNECTED CMsgGameServerMatchmakingStatus_PlayerConnectState = 1 // Is currently connected
	CMsgGameServerMatchmakingStatus_RESERVED  CMsgGameServerMatchmakingStatus_PlayerConnectState = 2 // I have a reservation ready for this guy and am acknowledging that you are expecting him
)
...
func (CMsgGameServerMatchmakingStatus_PlayerConnectState) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{98, 0}
}
...
func (CMsgGameServerMatchmakingStatus_Event) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{98, 1}
}
...
func (CMsgTFXPSource_XPSourceType) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{130, 0}
}
...
const (
	...
	CMsgGC_Match_Result_MATCH_FINISHED_ABANDON CMsgGC_Match_Result_Status = 7 // When we allow games to continue after an abandon
)
...
func (CMsgGC_Match_Result_Status) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{137, 0}
}

type CMsgGC_Match_Result_EventInfo_EventType int32

const (
	CMsgGC_Match_Result_EventInfo_EVENT_TYPE_KILL_PLAYER   CMsgGC_Match_Result_EventInfo_EventType = 0
	CMsgGC_Match_Result_EventInfo_EVENT_TYPE_CAPTURE_POINT CMsgGC_Match_Result_EventInfo_EventType = 1
)

// Enum value maps for CMsgGC_Match_Result_EventInfo_EventType.
var (
	CMsgGC_Match_Result_EventInfo_EventType_name = map[int32]string{
		0: "EVENT_TYPE_KILL_PLAYER",
		1: "EVENT_TYPE_CAPTURE_POINT",
	}
	CMsgGC_Match_Result_EventInfo_EventType_value = map[string]int32{
		"EVENT_TYPE_KILL_PLAYER":   0,
		"EVENT_TYPE_CAPTURE_POINT": 1,
	}
)

func (x CMsgGC_Match_Result_EventInfo_EventType) Enum() *CMsgGC_Match_Result_EventInfo_EventType {
	p := new(CMsgGC_Match_Result_EventInfo_EventType)
	*p = x
	return p
}

func (x CMsgGC_Match_Result_EventInfo_EventType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CMsgGC_Match_Result_EventInfo_EventType) Descriptor() protoreflect.EnumDescriptor {
	return file_tf_gcmessages_proto_enumTypes[27].Descriptor()
}

func (CMsgGC_Match_Result_EventInfo_EventType) Type() protoreflect.EnumType {
	return &file_tf_gcmessages_proto_enumTypes[27]
}

func (x CMsgGC_Match_Result_EventInfo_EventType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *CMsgGC_Match_Result_EventInfo_EventType) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = CMsgGC_Match_Result_EventInfo_EventType(num)
	return nil
}

// Deprecated: Use CMsgGC_Match_Result_EventInfo_EventType.Descriptor instead.
func (CMsgGC_Match_Result_EventInfo_EventType) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{137, 1, 0}
}
...
func (CMsgGC_ReportPlayer_EReason) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{148, 0}
}
...
const (
	...
	CMsgGCDataCenterPing_Update_Unreachable      CMsgGCDataCenterPing_Update_Status = 2 // Value is stale or not provided, DC is unreachable
	CMsgGCDataCenterPing_Update_FallbackToDCPing CMsgGCDataCenterPing_Update_Status = 3 // Deprecated: Couldn't ping router directly, this is a less-accurate DC ping value.
)
...
func (CMsgGCDataCenterPing_Update_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_tf_gcmessages_proto_enumTypes[29].Descriptor()
}

func (CMsgGCDataCenterPing_Update_Status) Type() protoreflect.EnumType {
	return &file_tf_gcmessages_proto_enumTypes[29]
}
...
func (CMsgGCDataCenterPing_Update_Status) EnumDescriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{155, 0}
}

// k_EMsgGC_GameServer_UpdateData
type CMsgGameServerData struct {
	...
	ServerSteamid       *uint64                      `protobuf:"fixed64,32,opt,name=server_steamid,json=serverSteamid" json:"server_steamid,omitempty"`
	...
	GameServerToken     *string                      `protobuf:"bytes,31,opt,name=game_server_token,json=gameServerToken" json:"game_server_token,omitempty"`
...
func (x *CMsgGameServerData) GetServerSteamid() uint64 {
...
func (x *CMsgGameServerData) GetGameServerToken() string {
...
func (x *CMsgGSUserPlaying) GetFakeIp() uint32 {
	if x != nil && x.FakeIp != nil {
		return *x.FakeIp
	}
	return 0
...
type CMsgTFGoldenWrenchBroadcast struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	WrenchNumber  *int32                 `protobuf:"varint,1,opt,name=wrench_number,json=wrenchNumber" json:"wrench_number,omitempty"` // number of the deleted wrench
	Deleted       *bool                  `protobuf:"varint,2,opt,name=deleted" json:"deleted,omitempty"`                               // true if the wrench was deleted
	UserName      *string                `protobuf:"bytes,3,opt,name=user_name,json=userName" json:"user_name,omitempty"`              // name of the user who deleted the wrench
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgTFSaxxyBroadcast struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	CategoryNumber *int32                 `protobuf:"varint,1,opt,name=category_number,json=categoryNumber" json:"category_number,omitempty"` // number of the deleted wrench
	UserName       *string                `protobuf:"bytes,2,opt,name=user_name,json=userName" json:"user_name,omitempty"`                    // name of the user who deleted the wrench
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type CMsgGCTFSpecificItemBroadcast struct {
	...
	WasDestruction *bool                  `protobuf:"varint,2,opt,name=was_destruction,json=wasDestruction" json:"was_destruction,omitempty"` // true if this item was destroyed, false if a new one was created
	UserName       *string                `protobuf:"bytes,3,opt,name=user_name,json=userName" json:"user_name,omitempty"`                    // name of the user who deleted the wrench
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type CSOTFPlayerInfo struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	NumNewUsersHelped *uint32                `protobuf:"varint,1,opt,name=num_new_users_helped,json=numNewUsersHelped" json:"num_new_users_helped,omitempty"` //	optional	bool		trial_account = 2 [ default = false ];	// DEPRECATED
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type CMsgTFCoaching_FindCoach struct {
	state                  protoimpl.MessageState `protogen:"open.v1"`
	AccountIdFriendAsCoach *uint32                `protobuf:"varint,1,opt,name=account_id_friend_as_coach,json=accountIdFriendAsCoach" json:"account_id_friend_as_coach,omitempty"` // @todo fill with criteria to match coach?
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type CMsgTFQuickplay_ScoreServers struct {
	state         protoimpl.MessageState                     `protogen:"open.v1"`
	Servers       []*CMsgTFQuickplay_ScoreServers_ServerInfo `protobuf:"bytes,1,rep,name=servers" json:"servers,omitempty"` // a list of servers
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgTFQuickplay_ScoreServersResponse struct {
	state         protoimpl.MessageState                             `protogen:"open.v1"`
	Servers       []*CMsgTFQuickplay_ScoreServersResponse_ServerInfo `protobuf:"bytes,1,rep,name=servers" json:"servers,omitempty"` // list of servers
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgGC_GameServer_AuthResult struct {
	...
	Message                 *string                `protobuf:"bytes,5,opt,name=message" json:"message,omitempty"` // error message to explain failure or success.
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
type CMsgGC_GameServer_CreateIdentityResponse struct {
	...
	Status                  *CMsgGC_GameServer_CreateIdentityResponse_EStatus `protobuf:"varint,4,opt,name=status,enum=CMsgGC_GameServer_CreateIdentityResponse_EStatus" json:"status,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *CMsgGC_GameServer_CreateIdentityResponse) GetStatus() CMsgGC_GameServer_CreateIdentityResponse_EStatus {
	...
	return CMsgGC_GameServer_CreateIdentityResponse_kStatus_GenericFailure
}
...
type CMsgGC_Client_UseServerModificationItem_Response struct {
	state         protoimpl.MessageState                                                            `protogen:"open.v1"`
	ResponseCode  *CMsgGC_Client_UseServerModificationItem_Response_EServerModificationItemResponse `protobuf:"varint,1,opt,name=response_code,json=responseCode,enum=CMsgGC_Client_UseServerModificationItem_Response_EServerModificationItemResponse" json:"response_code,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CMsgGC_Client_UseServerModificationItem_Response) GetResponseCode() CMsgGC_Client_UseServerModificationItem_Response_EServerModificationItemResponse {
	...
	return CMsgGC_Client_UseServerModificationItem_Response_kServerModificationItemResponse_AlreadyInUse
}

// k_EMsgGC_GameServer_UseServerModificationItem
type CMsgGC_GameServer_UseServerModificationItem struct {
	state            protoimpl.MessageState       `protogen:"open.v1"`
	ModificationType *EServerModificationItemType `protobuf:"varint,1,opt,name=modification_type,json=modificationType,enum=EServerModificationItemType" json:"modification_type,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CMsgGC_GameServer_UseServerModificationItem) GetModificationType() EServerModificationItemType {
	...
	return EServerModificationItemType_kGameServerModificationItem_Halloween
}
...
func (x *CMsgGC_GameServer_UseServerModificationItem_Response) GetServerResponseCode() CMsgGC_GameServer_UseServerModificationItem_Response_EServerModificationItemServerResponse {
	...
	return CMsgGC_GameServer_UseServerModificationItem_Response_kServerModificationItemServerResponse_Accepted
}
...
type CMsgGC_Halloween_GrantItem struct {
	...
	Flagged            *bool                  `protobuf:"varint,3,opt,name=flagged" json:"flagged,omitempty"` // This is ambiguously named on purpose. It means flagged as a cheater (noclipper). Used for logging cheaters in the backend.
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type CMsgGC_PickupItemEligibility_Query struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AccountId     *uint32                `protobuf:"varint,1,opt,name=account_id,json=accountId" json:"account_id,omitempty"`
	SecondsAgo    *uint32                `protobuf:"varint,2,opt,name=seconds_ago,json=secondsAgo" json:"seconds_ago,omitempty"` // positive, how many seconds ago was the item claimed
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgGC_PickupItemEligibility_QueryResponse struct {
	...
	LevelId       *uint32                `protobuf:"varint,3,opt,name=level_id,json=levelId" json:"level_id,omitempty"` // we can't trust the level that the server reports as so we have clients vote
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CSOTFPartyMember struct {
	...
	OwnsTicket        *bool   `protobuf:"varint,2,opt,name=owns_ticket,json=ownsTicket" json:"owns_ticket,omitempty"`                      // Do they have a ticket in their inventory?
	CompletedMissions *uint32 `protobuf:"varint,3,opt,name=completed_missions,json=completedMissions" json:"completed_missions,omitempty"` // Which missions have they completed (of the
	// currently selected tour)
	BadgeLevel        *uint32 `protobuf:"varint,4,opt,name=badge_level,json=badgeLevel" json:"badge_level,omitempty"`                      // Level of their badge
	CompetitiveAccess *bool   `protobuf:"varint,9,opt,name=competitive_access,json=competitiveAccess" json:"competitive_access,omitempty"` // access to ranked ladder mode
...
type TFPendingPartyMember struct {
	...
	Inviter       *uint64                     `protobuf:"fixed64,3,opt,name=inviter" json:"inviter,omitempty"` // User who invited us
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CTFGroupMatchCriteriaProto struct {
	...
	LateJoinOk          *bool   `protobuf:"varint,5,opt,name=late_join_ok,json=lateJoinOk" json:"late_join_ok,omitempty"`                                   // Is my party willing to join late?
	CustomPingTolerance *uint32 `protobuf:"varint,13,opt,name=custom_ping_tolerance,json=customPingTolerance,def=0" json:"custom_ping_tolerance,omitempty"` // 0 == no custom tolerance
	// MvM options
	// Deprecated:
	// optional string                 challenge                = 4; // Requested pop file (empty string for "any")
	MvmMannupTour       *string  `protobuf:"bytes,10,opt,name=mvm_mannup_tour,json=mvmMannupTour" json:"mvm_mannup_tour,omitempty"`                   // Selected Mann Up tour.  (Mann UP only)
	MvmMannupMissions   []string `protobuf:"bytes,15,rep,name=mvm_mannup_missions,json=mvmMannupMissions" json:"mvm_mannup_missions,omitempty"`       // Pop files we are willing to play in Mann Up.  NOTE: An empty list means "no change", it doesn't mean "none".  We pass "invalid" to indicate an empty list
	MvmBootcampMissions []string `protobuf:"bytes,16,rep,name=mvm_bootcamp_missions,json=mvmBootcampMissions" json:"mvm_bootcamp_missions,omitempty"` // Pop files we are willing to play in Boot Camp.  NOTE: An empty list means "no change", it doesn't mean "none".  We pass "invalid" to indicate an empty list
	// Casual
	CasualCriteria *CTFCasualMatchCriteria `protobuf:"bytes,12,opt,name=casual_criteria,json=casualCriteria" json:"casual_criteria,omitempty"` // Search criteria for casual games
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type CTFCasualMatchCriteria struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	SelectedMapsBits []uint32               `protobuf:"fixed32,3,rep,name=selected_maps_bits,json=selectedMapsBits" json:"selected_maps_bits,omitempty"` // Bitfield of selected maps from the "master_maps_list" in _maps.txt
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type CTFPerPlayerMatchCriteriaProto struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	MvmSquadSurplus *bool                  `protobuf:"varint,1,opt,name=mvm_squad_surplus,json=mvmSquadSurplus" json:"mvm_squad_surplus,omitempty"` // Presenting voucher for the team to get "surplus"
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type CTFPartyOptions struct {
	...
	OverwriteExisting *bool                           `protobuf:"varint,1,opt,name=overwrite_existing,json=overwriteExisting" json:"overwrite_existing,omitempty"` // Overwrite or merge with existing
...
type CMsgPartyQueueForMatch struct {
	...
	MatchGroup    *ETFMatchGroup         `protobuf:"varint,3,opt,name=match_group,json=matchGroup,enum=ETFMatchGroup" json:"match_group,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CMsgPartyQueueForMatch) GetMatchGroup() ETFMatchGroup {
	...
	return ETFMatchGroup_k_eTFMatchGroup_Invalid
}
...
type CMsgPartyRemoveFromQueue struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PartyId       *uint64                `protobuf:"fixed64,1,opt,name=party_id,json=partyId" json:"party_id,omitempty"`
	MatchGroup    *ETFMatchGroup         `protobuf:"varint,2,opt,name=match_group,json=matchGroup,enum=ETFMatchGroup" json:"match_group,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgPartyMMError struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          *CMsgPartyMMError_Type `protobuf:"varint,1,opt,name=type,enum=CMsgPartyMMError_Type" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CMsgPartyMMError) GetType() CMsgPartyMMError_Type {
	...
	return CMsgPartyMMError_QUEUE_KICK_NO_PING
}
...
type CMsgPartyChatMsg struct {
	...
	Type          *ETFPartyChatType `protobuf:"varint,1,opt,name=type,enum=ETFPartyChatType" json:"type,omitempty"`
	ActorId       *uint64           `protobuf:"fixed64,2,opt,name=actor_id,json=actorId" json:"actor_id,omitempty"` // foo
	Msg           *string           `protobuf:"bytes,3,opt,name=msg" json:"msg,omitempty"`                          // foo
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CMsgPartyChatMsg) GetType() ETFPartyChatType {
	...
	return ETFPartyChatType_k_eTFPartyChatType_Invalid
}
...
type CSOTFParty struct {
	...
	AssociatedLobbyMatchGroup *ETFMatchGroup              `protobuf:"varint,40,opt,name=associated_lobby_match_group,json=associatedLobbyMatchGroup,enum=ETFMatchGroup" json:"associated_lobby_match_group,omitempty"`
	...
	CasualBannedTime      *uint32 `protobuf:"varint,18,opt,name=casual_banned_time,json=casualBannedTime" json:"casual_banned_time,omitempty"`                  // party can't matchmake until this time
	CasualLowPriorityTime *uint32 `protobuf:"varint,20,opt,name=casual_low_priority_time,json=casualLowPriorityTime" json:"casual_low_priority_time,omitempty"` // if set, any official matchmaking mode will treat this party as low priority (superceded by prevent_match_until_date)
	RankedBannedTime      *uint32 `protobuf:"varint,41,opt,name=ranked_banned_time,json=rankedBannedTime" json:"ranked_banned_time,omitempty"`                  // party can't matchmake until this time
	RankedLowPriorityTime *uint32 `protobuf:"varint,42,opt,name=ranked_low_priority_time,json=rankedLowPriorityTime" json:"ranked_low_priority_time,omitempty"` // if set, any official matchmaking mode will treat this party as low priority (superceded by prevent_match_until_date)
	// Deprecated: Changed format
...
type CSOTFPartyInvite struct {
	...
	Type          *CSOTFPartyInvite_Type          `protobuf:"varint,5,opt,name=type,enum=CSOTFPartyInvite_Type" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CSOTFPartyInvite) GetType() CSOTFPartyInvite_Type {
	...
	return CSOTFPartyInvite_PENDING_INVITE
}
...
type CTFLobbyPlayerProto struct {
	...
	Team  *TF_GC_TEAM            `protobuf:"varint,3,opt,name=team,enum=TF_GC_TEAM" json:"team,omitempty"`
	// optional bool              connected_to_game_server    = 4;
	ConnectState *CTFLobbyPlayerProto_ConnectState `protobuf:"varint,13,opt,name=connect_state,json=connectState,enum=CTFLobbyPlayerProto_ConnectState" json:"connect_state,omitempty"`
	...
	LastConnectTime       *uint32                   `protobuf:"varint,17,opt,name=last_connect_time,json=lastConnectTime" json:"last_connect_time,omitempty"` // last time player was online or their state changed.
	Type                  *CTFLobbyPlayerProto_Type `protobuf:"varint,19,opt,name=type,enum=CTFLobbyPlayerProto_Type" json:"type,omitempty"`
	...
	ChatSuspension        *bool                     `protobuf:"varint,23,opt,name=chat_suspension,json=chatSuspension" json:"chat_suspension,omitempty"` // If this player has a chat/interaction suspension in
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *CTFLobbyPlayerProto) GetTeam() TF_GC_TEAM {
	...
	return TF_GC_TEAM_TF_GC_TEAM_DEFENDERS
}
...
func (x *CTFLobbyPlayerProto) GetConnectState() CTFLobbyPlayerProto_ConnectState {
	...
	return CTFLobbyPlayerProto_INVALID
}
...
func (x *CTFLobbyPlayerProto) GetType() CTFLobbyPlayerProto_Type {
	...
	return CTFLobbyPlayerProto_INVALID_PLAYER
}
...
type CSOTFGameServerLobby struct {
	...
	Members []*CTFLobbyPlayerProto `protobuf:"bytes,2,rep,name=members" json:"members,omitempty"` // members assigned to this lobby
	...
	Connect  *string                     `protobuf:"bytes,5,opt,name=connect" json:"connect,omitempty"` // connect string usually something like
	...
	GameState *TF_GC_GameState `protobuf:"varint,22,opt,name=game_state,json=gameState,enum=TF_GC_GameState" json:"game_state,omitempty"` // This isn't set by the lobby, but is networked
	...
	MannupTourName *string `protobuf:"bytes,42,opt,name=mannup_tour_name,json=mannupTourName" json:"mannup_tour_name,omitempty"` // MvM tour we're playing for bragging rights.
	// (Should not be set if not playing for bragging
	// rights.)
	MapName     *string `protobuf:"bytes,38,opt,name=map_name,json=mapName" json:"map_name,omitempty"`             // Map we're currently playing
	MissionName *string `protobuf:"bytes,39,opt,name=mission_name,json=missionName" json:"mission_name,omitempty"` // Challenge we're currently playing
	...
	//
	// replay salt
	FormedTime *uint32 `protobuf:"varint,36,opt,name=formed_time,json=formedTime" json:"formed_time,omitempty"` // timestamp of when we created this lobby
	Flags      *uint32 `protobuf:"varint,43,opt,name=flags" json:"flags,omitempty"`                             // general bitfield (see tf_matchmaking_shared.h
	// for flags, e.g. LOBBY_FLAG_LOWPRIORITY)
	LateJoinEligible *bool `protobuf:"varint,44,opt,name=late_join_eligible,json=lateJoinEligible" json:"late_join_eligible,omitempty"` // If this lobby is entered into the late join
	// system
...
func (x *CSOTFGameServerLobby) GetGameState() TF_GC_GameState {
	...
	return TF_GC_GameState_TF_GC_GAMESTATE_STATE_INIT
}
...
type CMsgGameServerMatchmakingStatus struct {
	...
	Map             *string                                   `protobuf:"bytes,3,opt,name=map" json:"map,omitempty"`                            // Current map
	Tags            *string                                   `protobuf:"bytes,4,opt,name=tags" json:"tags,omitempty"`                          // Current tags
	BotCount        *uint32                                   `protobuf:"varint,5,opt,name=bot_count,json=botCount" json:"bot_count,omitempty"` // Number of bots
	NumSpectators   *uint32                                   `protobuf:"varint,6,opt,name=num_spectators,json=numSpectators" json:"num_spectators,omitempty"`
	MaxPlayers      *uint32                                   `protobuf:"varint,7,opt,name=max_players,json=maxPlayers" json:"max_players,omitempty"`                 // Advertised max number of players
	SlotsFree       *uint32                                   `protobuf:"varint,8,opt,name=slots_free,json=slotsFree" json:"slots_free,omitempty"`                    // Biggest possible lobby we could accept right now
	ServerRegion    *uint32                                   `protobuf:"varint,9,opt,name=server_region,json=serverRegion" json:"server_region,omitempty"`           // Region value that matches regions.txt in the GC
	ServerLoadavg   *float32                                  `protobuf:"fixed32,10,opt,name=server_loadavg,json=serverLoadavg" json:"server_loadavg,omitempty"`      // current load average
	ServerTrusted   *bool                                     `protobuf:"varint,11,opt,name=server_trusted,json=serverTrusted" json:"server_trusted,omitempty"`       // server requests to be put into the trusted pool
	ServerDedicated *bool                                     `protobuf:"varint,12,opt,name=server_dedicated,json=serverDedicated" json:"server_dedicated,omitempty"` // Is this a dedicated server?  (As opposed to a listen server)
	Strict          *uint32                                   `protobuf:"varint,17,opt,name=strict" json:"strict,omitempty"`                                          // Current value of tf_mm_strict
	FakeIp          *string                                   `protobuf:"bytes,25,opt,name=fake_ip,json=fakeIp" json:"fake_ip,omitempty"`                             // If we have a FakeIP, what is it?
	Players         []*CMsgGameServerMatchmakingStatus_Player `protobuf:"bytes,13,rep,name=players" json:"players,omitempty"`
	GameState       *TF_GC_GameState                          `protobuf:"varint,14,opt,name=game_state,json=gameState,enum=TF_GC_GameState" json:"game_state,omitempty"`
	...
	MvmWave            *uint32 `protobuf:"varint,18,opt,name=mvm_wave,json=mvmWave" json:"mvm_wave,omitempty"`                                    // Current MvM wave number
	MvmCreditsAcquired *uint32 `protobuf:"varint,19,opt,name=mvm_credits_acquired,json=mvmCreditsAcquired" json:"mvm_credits_acquired,omitempty"` // Cash collected
	MvmCreditsDropped  *uint32 `protobuf:"varint,20,opt,name=mvm_credits_dropped,json=mvmCreditsDropped" json:"mvm_credits_dropped,omitempty"`    // Cash failed to collect and lost
	MatchGroup         *int32  `protobuf:"zigzag32,23,opt,name=match_group,json=matchGroup,def=-1" json:"match_group,omitempty"`                  // The current match group. -1 if none.  Type sint since it'll be negative often
...
type CMsgMatchmakingProgress struct {
	state                             protoimpl.MessageState `protogen:"open.v1"`
	AvgWaitTimeNew                    *uint32                `protobuf:"varint,4,opt,name=avg_wait_time_new,json=avgWaitTimeNew" json:"avg_wait_time_new,omitempty"`                  // Average wait time for a new game for people with similar search criteria
	AvgWaitTimeJoinLate               *uint32                `protobuf:"varint,5,opt,name=avg_wait_time_join_late,json=avgWaitTimeJoinLate" json:"avg_wait_time_join_late,omitempty"` // Average wait time for a late join for people with similar search criteria
	YourWaitTime                      *uint32                `protobuf:"varint,6,opt,name=your_wait_time,json=yourWaitTime" json:"your_wait_time,omitempty"`                          // Time that we think you have been waiting
...
type CMsgMvMVictory struct {
	state              protoimpl.MessageState   `protogen:"open.v1"`
	LegacyMissionIndex *uint32                  `protobuf:"varint,1,opt,name=legacy_mission_index,json=legacyMissionIndex" json:"legacy_mission_index,omitempty"` // needed for the first prop, when old gameservers may report victory to a new GC.  After we update the gameservers, delete it
	TourNameMannup     *string                  `protobuf:"bytes,5,opt,name=tour_name_mannup,json=tourNameMannup" json:"tour_name_mannup,omitempty"`              // Only present if we're playing for bragging rights (Mann Up)
...
type CMsgLeaveGameAndPrepareToJoinParty struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PartyId       *uint64                `protobuf:"fixed64,1,opt,name=party_id,json=partyId" json:"party_id,omitempty"` // The party that has been created that you are now a member of
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgPlayerLeftMatch struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SteamId       *uint64                `protobuf:"fixed64,1,opt,name=steam_id,json=steamId" json:"steam_id,omitempty"`
	LeaveReason   *TFMatchLeaveReason    `protobuf:"varint,2,opt,name=leave_reason,json=leaveReason,enum=TFMatchLeaveReason" json:"leave_reason,omitempty"`
	WasAbandon    *bool                  `protobuf:"varint,3,opt,name=was_abandon,json=wasAbandon" json:"was_abandon,omitempty"` // Player was not cleared to leave, this is abandoning
...
func (x *CMsgPlayerLeftMatch) GetLeaveReason() TFMatchLeaveReason {
	...
	return TFMatchLeaveReason_TFMatchLeaveReason_UNSPECIFIED
}
...
type CMsgProcessMatchVoteKick struct {
	...
	Reason           *TFVoteKickReason                `protobuf:"varint,4,opt,name=reason,enum=TFVoteKickReason" json:"reason,omitempty"`
	Votes            []*CMsgProcessMatchVoteKick_Vote `protobuf:"bytes,5,rep,name=votes" json:"votes,omitempty"`                                 // All votes
	DefaultPass      *bool                            `protobuf:"varint,6,opt,name=default_pass,json=defaultPass" json:"default_pass,omitempty"` // Would the vote system normally pass this vote
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CMsgProcessMatchVoteKick) GetReason() TFVoteKickReason {
	...
	return TFVoteKickReason_TFVoteKickReason_Invalid
}
...
type CMsgProcessMatchVoteKickResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Rip           *bool                  `protobuf:"varint,1,opt,name=rip" json:"rip,omitempty"` // Do they go away
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgHalloween_ServerBossEvent struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	EventCounter    *uint32                `protobuf:"varint,1,opt,name=event_counter,json=eventCounter" json:"event_counter,omitempty"`          // uint8
	Timestamp       *uint32                `protobuf:"varint,2,opt,name=timestamp" json:"timestamp,omitempty"`                                    // sent up from server for consistency
	BossType        *uint32                `protobuf:"varint,3,opt,name=boss_type,json=bossType" json:"boss_type,omitempty"`                      // uint8
	BossLevel       *uint32                `protobuf:"varint,4,opt,name=boss_level,json=bossLevel" json:"boss_level,omitempty"`                   // uint16
	EventType       *uint32                `protobuf:"varint,5,opt,name=event_type,json=eventType" json:"event_type,omitempty"`                   // uint8
	PlayersInvolved *uint32                `protobuf:"varint,6,opt,name=players_involved,json=playersInvolved" json:"players_involved,omitempty"` // uint8
...
type CMsgHalloween_Merasmus2012 struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	EventCounter    *uint32                `protobuf:"varint,1,opt,name=event_counter,json=eventCounter" json:"event_counter,omitempty"`     // uint8
	TimeSubmitted   *uint32                `protobuf:"fixed32,2,opt,name=time_submitted,json=timeSubmitted" json:"time_submitted,omitempty"` // sent up from server for consistency
	...
	RemainingHealth *uint32                `protobuf:"varint,6,opt,name=remaining_health,json=remainingHealth" json:"remaining_health,omitempty"` // 0 == Boss was killed
	LifeTime        *uint32                `protobuf:"varint,7,opt,name=life_time,json=lifeTime" json:"life_time,omitempty"`                      // Amount of time in seconds, boss was alive for
	BombKills       *uint32                `protobuf:"varint,8,opt,name=bomb_kills,json=bombKills" json:"bomb_kills,omitempty"`                   // Kills from Bombs
	StaffKills      *uint32                `protobuf:"varint,9,opt,name=staff_kills,json=staffKills" json:"staff_kills,omitempty"`                // kills from staff attack
	PvpKills        *uint32                `protobuf:"varint,10,opt,name=pvp_kills,json=pvpKills" json:"pvp_kills,omitempty"`                     // Number of kills from players while Boss is out (Jerk factor)
	...
	DmgScout        *uint32                `protobuf:"varint,13,opt,name=dmg_scout,json=dmgScout" json:"dmg_scout,omitempty"` // Amount of damage done by each class
	...
	ScoutCount      *uint32                `protobuf:"varint,22,opt,name=scout_count,json=scoutCount" json:"scout_count,omitempty"` // Class and player break down at the point of boss despawn
...
type CMsgUpdateHalloweenMerasmusLootLevel struct {
	...
	MerasmusLevel *uint32                                        `protobuf:"varint,2,opt,name=merasmus_level,json=merasmusLevel" json:"merasmus_level,omitempty"` // uint8
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CSOWarData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AccountId     *uint32                `protobuf:"varint,1,opt,name=account_id,json=accountId" json:"account_id,omitempty"`          // Account of who's data this belongs to
	WarId         *uint32                `protobuf:"varint,2,opt,name=war_id,json=warId" json:"war_id,omitempty"`                      // ID of the war
	Affiliation   *uint32                `protobuf:"varint,3,opt,name=affiliation" json:"affiliation,omitempty"`                       // Which side they're affiliated with
	PointsScored  *uint32                `protobuf:"varint,4,opt,name=points_scored,json=pointsScored" json:"points_scored,omitempty"` // How many points they've scored
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CGCMsgGC_War_IndividualUpdate struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SteamId       *uint64                `protobuf:"fixed64,1,opt,name=steam_id,json=steamId" json:"steam_id,omitempty"` // Who scored
	WarId         *uint32                `protobuf:"varint,2,opt,name=war_id,json=warId" json:"war_id,omitempty"`        // Which war
	Score         *uint32                `protobuf:"varint,3,opt,name=score" json:"score,omitempty"`                     // How many points did they score
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CGCMsgGC_War_JoinWar struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Affiliation   *uint32                `protobuf:"varint,1,opt,name=affiliation" json:"affiliation,omitempty"`  // Which side we're joining
	WarId         *uint32                `protobuf:"varint,2,opt,name=war_id,json=warId" json:"war_id,omitempty"` // Which war
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CGCMsg_WorldItemPlacement_Update struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	OriginalItemId *uint64                `protobuf:"varint,1,opt,name=original_item_id,json=originalItemId" json:"original_item_id,omitempty"` // Passing INVALID_ITEM_ID will reset this attribute
	PosX           *float32               `protobuf:"fixed32,2,opt,name=pos_x,json=posX" json:"pos_x,omitempty"`
	PosY           *float32               `protobuf:"fixed32,3,opt,name=pos_y,json=posY" json:"pos_y,omitempty"`
	PosZ           *float32               `protobuf:"fixed32,4,opt,name=pos_z,json=posZ" json:"pos_z,omitempty"`
	AngX           *float32               `protobuf:"fixed32,5,opt,name=ang_x,json=angX" json:"ang_x,omitempty"`
	AngY           *float32               `protobuf:"fixed32,6,opt,name=ang_y,json=angY" json:"ang_y,omitempty"`
	AngZ           *float32               `protobuf:"fixed32,7,opt,name=ang_z,json=angZ" json:"ang_z,omitempty"`
	ForceRemoveAll *bool                  `protobuf:"varint,8,opt,name=force_remove_all,json=forceRemoveAll" json:"force_remove_all,omitempty"` // Reset every attribute of this type on the owning item (make separate msg?)
	AttribName     *string                `protobuf:"bytes,9,opt,name=attrib_name,json=attribName" json:"attrib_name,omitempty"`                // The attribute we're applying the update to
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type CMsgTFXPSource struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Type          *CMsgTFXPSource_XPSourceType `protobuf:"varint,1,opt,name=type,enum=CMsgTFXPSource_XPSourceType" json:"type,omitempty"`
...
func (x *CMsgTFXPSource) GetType() CMsgTFXPSource_XPSourceType {
	...
	return CMsgTFXPSource_SOURCE_SCORE
}
...
type CMsgTFClientInit struct {
	...
	Language      *int32                 `protobuf:"varint,2,opt,name=language" json:"language,omitempty"` // ELanguage
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgGC_Match_Result struct {
	...
	Status      *CMsgGC_Match_Result_Status   `protobuf:"varint,3,opt,name=status,enum=CMsgGC_Match_Result_Status" json:"status,omitempty"`
	...
	Flags     *uint32 `protobuf:"varint,14,opt,name=flags" json:"flags,omitempty"` // bit field
	// Deprecated - Unused
	// optional uint32 server_version = 15;
	Bots          *uint32                          `protobuf:"varint,16,opt,name=bots" json:"bots,omitempty"` // count of bots added during match
	Events        []*CMsgGC_Match_Result_EventInfo `protobuf:"bytes,18,rep,name=events" json:"events,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CMsgGC_Match_Result) GetStatus() CMsgGC_Match_Result_Status {
	...
	return CMsgGC_Match_Result_MATCH_SUCCEEDED
}
...
func (x *CMsgGC_Match_Result) GetEvents() []*CMsgGC_Match_Result_EventInfo {
	if x != nil {
		return x.Events
	}
	return nil
...
type CSOTFRatingData struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	AccountId  *uint32                `protobuf:"varint,1,opt,name=account_id,json=accountId" json:"account_id,omitempty"`
	RatingType *int32                 `protobuf:"varint,2,opt,name=rating_type,json=ratingType" json:"rating_type,omitempty"` // int16 in the db
...
type CMsgGC_VoteKickPlayerRequestResponse struct {
	...
	VoterInhibit  *bool `protobuf:"varint,3,opt,name=voter_inhibit,json=voterInhibit" json:"voter_inhibit,omitempty"`    // This voter should not be allowed to try any more
	TargetInhibit *bool `protobuf:"varint,4,opt,name=target_inhibit,json=targetInhibit" json:"target_inhibit,omitempty"` // This target cannot be targeted
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgGC_ReportPlayer struct {
	...
	Reason          *CMsgGC_ReportPlayer_EReason `protobuf:"varint,2,opt,name=reason,enum=CMsgGC_ReportPlayer_EReason" json:"reason,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *CMsgGC_ReportPlayer) GetReason() CMsgGC_ReportPlayer_EReason {
	...
	return CMsgGC_ReportPlayer_kReason_INVALID
}
...
type CMsgGCDataCenterPopulation struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          *string                `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`                                    // data center name
	HealthRatio   *float32               `protobuf:"fixed32,2,opt,name=health_ratio,json=healthRatio" json:"health_ratio,omitempty"` // population health ratio with best ping in the data center
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgGC_KickPlayerFromLobby struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TargetID      *uint64                `protobuf:"varint,1,opt,name=targetID" json:"targetID,omitempty"` // kick target ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgGCSurveyRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	QuestionType  *SurveyQuestionType    `protobuf:"varint,1,opt,name=question_type,json=questionType,enum=SurveyQuestionType" json:"question_type,omitempty"`
...
func (x *CMsgGCSurveyRequest) GetQuestionType() SurveyQuestionType {
	...
	return SurveyQuestionType_QUESTION_MATCH_QUALITY
}
...
type CSOQuestMapNode struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	AccountId        *uint32                `protobuf:"varint,1,opt,name=account_id,json=accountId" json:"account_id,omitempty"` // Account of who owns this map
	Defindex         *uint32                `protobuf:"varint,3,opt,name=defindex" json:"defindex,omitempty"`                    // Defindex that defines this node's properties
	NodeId           *uint32                `protobuf:"varint,4,opt,name=node_id,json=nodeId" json:"node_id,omitempty"`          // Unique ID of this node
	...
	LootClaimed      *bool                  `protobuf:"varint,9,opt,name=loot_claimed,json=lootClaimed,def=0" json:"loot_claimed,omitempty"`                   // Has the user claimed the loot for this node yet?
	SelectedQuestDef *uint32                `protobuf:"varint,10,opt,name=selected_quest_def,json=selectedQuestDef,def=0" json:"selected_quest_def,omitempty"` // The quest the user has selected for this node.  0 == not selected yet.
	MapCycle         *uint32                `protobuf:"varint,11,opt,name=map_cycle,json=mapCycle" json:"map_cycle,omitempty"`                                 // Which cycle of the map this uses.  0 is the current.  Buying additional maps will put the current set at the highest MapCycle the users owns + 1, and the new set at 0
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type CSOQuest struct {
	...
	QuestMapNodeSourceId *uint32                `protobuf:"varint,8,opt,name=quest_map_node_source_id,json=questMapNodeSourceId" json:"quest_map_node_source_id,omitempty"` // The quest map node that we came from, and that'll we'll credit when turned in
	MapCycle             *uint32                `protobuf:"varint,9,opt,name=map_cycle,json=mapCycle" json:"map_cycle,omitempty"`                                           // Which cycle of the map this uses.  0 is the current.  Buying additional maps will put the current set at the highest MapCycle the users owns + 1, and the new set at 0
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type CSOQuestMapRewardPurchase struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AccountId     *uint32                `protobuf:"varint,1,opt,name=account_id,json=accountId" json:"account_id,omitempty"`
	Defindex      *uint32                `protobuf:"varint,2,opt,name=defindex" json:"defindex,omitempty"` // *Reward* defindex.  Not item defindex
	Count         *uint32                `protobuf:"varint,3,opt,name=count" json:"count,omitempty"`
	MapCycle      *uint32                `protobuf:"varint,4,opt,name=map_cycle,json=mapCycle" json:"map_cycle,omitempty"`       // Which cycle of the map this uses.  0 is the current.  Buying additional maps will put the current set at the highest MapCycle the users owns + 1, and the new set at 0
	PurchaseId    *uint32                `protobuf:"varint,5,opt,name=purchase_id,json=purchaseId" json:"purchase_id,omitempty"` // Unique ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgGCQuestMapPurchaseReward struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	StoreItemDefindex *uint32                `protobuf:"varint,1,opt,name=store_item_defindex,json=storeItemDefindex" json:"store_item_defindex,omitempty"` // CMsgQuestMapStoreItem defindex
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type CMsgPainkitDevGrant struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	PaintkitDefindex *uint32                `protobuf:"varint,1,opt,name=paintkit_defindex,json=paintkitDefindex" json:"paintkit_defindex,omitempty"` // Paintkit
	Wear             *float32               `protobuf:"fixed32,2,opt,name=wear" json:"wear,omitempty"`
	ItemDefindex     *uint32                `protobuf:"varint,3,opt,name=item_defindex,json=itemDefindex" json:"item_defindex,omitempty"` // Which item to put the Paintkit on.  If not set, give everything
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (*CMsgSDRTicket) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{179}
}
...
func (*CMsgAuthorizeServerItemRetrieval) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{180}
}
...
type CMsgGCToGCSendAccountBannedNotifications struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	BannedAccountid   *uint32                `protobuf:"varint,1,opt,name=banned_accountid,json=bannedAccountid" json:"banned_accountid,omitempty"`         // who got banned
	ReportPeriodBegin *uint32                `protobuf:"varint,2,opt,name=report_period_begin,json=reportPeriodBegin" json:"report_period_begin,omitempty"` // beginning of time period to check for reports
	ReportPeriodEnd   *uint32                `protobuf:"varint,3,opt,name=report_period_end,json=reportPeriodEnd" json:"report_period_end,omitempty"`       // end of time period to check for reports
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (*CMsgGCToGCSendAccountBannedNotifications) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{181}
}
...
func (*CMsgGCToGCSendNotification) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{182}
}
...
func (*CMsgGameServerData_Player) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{0, 0}
}
...
type CMsgTFQuickplay_ScoreServers_ServerInfo struct {
	...
	NumUsers      *uint32                `protobuf:"varint,3,opt,name=num_users,json=numUsers" json:"num_users,omitempty"` // number of users the server is reporting to us
	SteamId       *uint64                `protobuf:"varint,4,opt,name=steam_id,json=steamId" json:"steam_id,omitempty"`
	MaxUsers      *uint32                `protobuf:"varint,5,opt,name=max_users,json=maxUsers" json:"max_users,omitempty"`     // max number of users the server reported
	UserScore     *float32               `protobuf:"fixed32,6,opt,name=user_score,json=userScore" json:"user_score,omitempty"` // what the client scored the server based on ping, preferences, etc
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*CMsgTFQuickplay_ScoreServers_ServerInfo) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{32, 0}
}
...
func (*CMsgTFQuickplay_ScoreServersResponse_ServerInfo) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{33, 0}
}
...
func (*CMsgGC_GameServer_ListResponse_GameServerIdentity) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{42, 0}
}
...
type CSOTFPartyMember_Activity struct {
	...
	LobbyMatchGroup *ETFMatchGroup `protobuf:"varint,2,opt,name=lobby_match_group,json=lobbyMatchGroup,enum=ETFMatchGroup" json:"lobby_match_group,omitempty"`
...
func (*CSOTFPartyMember_Activity) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{59, 0}
}
...
type CSOTFParty_QueueEntry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MatchGroup    *ETFMatchGroup         `protobuf:"varint,1,opt,name=match_group,json=matchGroup,enum=ETFMatchGroup" json:"match_group,omitempty"`
...
type CMsgGameServerMatchmakingStatus_Player struct {
	state         protoimpl.MessageState                              `protogen:"open.v1"`
	SteamId       *uint64                                             `protobuf:"fixed64,1,opt,name=steam_id,json=steamId" json:"steam_id,omitempty"`
	ConnectState  *CMsgGameServerMatchmakingStatus_PlayerConnectState `protobuf:"varint,2,opt,name=connect_state,json=connectState,enum=CMsgGameServerMatchmakingStatus_PlayerConnectState" json:"connect_state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CMsgGameServerMatchmakingStatus_Player) GetConnectState() CMsgGameServerMatchmakingStatus_PlayerConnectState {
	...
	return CMsgGameServerMatchmakingStatus_INVALID
}

type CMsgMvMVictoryInfo_Item struct {
	state                      protoimpl.MessageState          `protogen:"open.v1"`
	GrantReason                *CMsgMvMVictoryInfo_GrantReason `protobuf:"varint,1,opt,name=grant_reason,json=grantReason,enum=CMsgMvMVictoryInfo_GrantReason" json:"grant_reason,omitempty"`                 // why are we receiving this?
	ItemData                   []byte                          `protobuf:"bytes,2,opt,name=item_data,json=itemData" json:"item_data,omitempty"`                                                               // buffer that can be parsed by CEconItem::BParseCreateFromMessage
	SquadSurplusClaimerSteamId *uint64                         `protobuf:"fixed64,3,opt,name=squad_surplus_claimer_steam_id,json=squadSurplusClaimerSteamId" json:"squad_surplus_claimer_steam_id,omitempty"` // for squad surplus, whose voucher is responsible for this?
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *CMsgMvMVictoryInfo_Item) GetGrantReason() CMsgMvMVictoryInfo_GrantReason {
	...
	return CMsgMvMVictoryInfo_INVALID
}
...
type CMsgMvMVictoryInfo_Player struct {
	state                protoimpl.MessageState     `protogen:"open.v1"`
	SteamId              *uint64                    `protobuf:"fixed64,1,opt,name=steam_id,json=steamId" json:"steam_id,omitempty"` //optional string player_name = 2;
...
func (*CMsgMvMVictoryInfo_Player) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{100, 1}
}
...
func (*CMsgMvMVictory_Player) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{104, 0}
}
...
type CMsgProcessMatchVoteKick_Vote struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SteamId       *uint64                `protobuf:"fixed64,1,opt,name=steam_id,json=steamId" json:"steam_id,omitempty"`
	VoteYay       *bool                  `protobuf:"varint,2,opt,name=vote_yay,json=voteYay" json:"vote_yay,omitempty"` // Kick em?
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*CMsgUpdateHalloweenMerasmusLootLevel_Player) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{115, 0}
}
...
func (x *CGCMsgGC_War_GlobalStatsResponse_SideScore) Reset() {
	*x = CGCMsgGC_War_GlobalStatsResponse_SideScore{}
	mi := &file_tf_gcmessages_proto_msgTypes[196]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CGCMsgGC_War_GlobalStatsResponse_SideScore) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{125, 0}
}
...
type CMsgGC_Match_Result_Player struct {
	...
	ClassesPlayed   *uint32             `protobuf:"varint,10,opt,name=classes_played,json=classesPlayed" json:"classes_played,omitempty"` // bit field
	Kills           *uint32             `protobuf:"varint,11,opt,name=kills" json:"kills,omitempty"`
	Deaths          *uint32             `protobuf:"varint,12,opt,name=deaths" json:"deaths,omitempty"`
	Damage          *uint32             `protobuf:"varint,13,opt,name=damage" json:"damage,omitempty"`
	Healing         *uint32             `protobuf:"varint,14,opt,name=healing" json:"healing,omitempty"`
	...
	LeaveReason     *TFMatchLeaveReason `protobuf:"varint,23,opt,name=leave_reason,json=leaveReason,enum=TFMatchLeaveReason" json:"leave_reason,omitempty"`
	ConnectTime     *uint32             `protobuf:"varint,24,opt,name=connect_time,json=connectTime" json:"connect_time,omitempty"`
	TimeOnClass     []float32           `protobuf:"fixed32,25,rep,name=time_on_class,json=timeOnClass" json:"time_on_class,omitempty"`
	GraphKills      []float32           `protobuf:"fixed32,26,rep,name=graph_kills,json=graphKills" json:"graph_kills,omitempty"`
	GraphDeaths     []float32           `protobuf:"fixed32,27,rep,name=graph_deaths,json=graphDeaths" json:"graph_deaths,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *CMsgGC_Match_Result_Player) Reset() {
	*x = CMsgGC_Match_Result_Player{}
	mi := &file_tf_gcmessages_proto_msgTypes[197]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *CMsgGC_Match_Result_Player) GetTimeOnClass() []float32 {
	if x != nil {
		return x.TimeOnClass
	}
	return nil
}

func (x *CMsgGC_Match_Result_Player) GetGraphKills() []float32 {
	if x != nil {
		return x.GraphKills
	}
	return nil
...
func (x *CMsgGC_Match_Result_Player) GetGraphDeaths() []float32 {
	if x != nil {
...
type CMsgGC_Match_Result_EventInfo struct {
	state         protoimpl.MessageState                   `protogen:"open.v1"`
	EventType     *CMsgGC_Match_Result_EventInfo_EventType `protobuf:"varint,1,opt,name=event_type,json=eventType,enum=CMsgGC_Match_Result_EventInfo_EventType,def=0" json:"event_type,omitempty"`
	VictimSteamId *uint64                                  `protobuf:"fixed64,2,opt,name=victim_steam_id,json=victimSteamId" json:"victim_steam_id,omitempty"`
	KillerSteamId []uint64                                 `protobuf:"fixed64,3,rep,name=killer_steam_id,json=killerSteamId" json:"killer_steam_id,omitempty"`
...
// Default values for CMsgGC_Match_Result_EventInfo fields.
const (
	Default_CMsgGC_Match_Result_EventInfo_EventType = CMsgGC_Match_Result_EventInfo_EVENT_TYPE_KILL_PLAYER
)

func (x *CMsgGC_Match_Result_EventInfo) Reset() {
	*x = CMsgGC_Match_Result_EventInfo{}
	mi := &file_tf_gcmessages_proto_msgTypes[198]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CMsgGC_Match_Result_EventInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CMsgGC_Match_Result_EventInfo) ProtoMessage() {}

func (x *CMsgGC_Match_Result_EventInfo) ProtoReflect() protoreflect.Message {
	mi := &file_tf_gcmessages_proto_msgTypes[198]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CMsgGC_Match_Result_EventInfo.ProtoReflect.Descriptor instead.
func (*CMsgGC_Match_Result_EventInfo) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{137, 1}
}

func (x *CMsgGC_Match_Result_EventInfo) GetEventType() CMsgGC_Match_Result_EventInfo_EventType {
	if x != nil && x.EventType != nil {
		return *x.EventType
	}
	return Default_CMsgGC_Match_Result_EventInfo_EventType
}

func (x *CMsgGC_Match_Result_EventInfo) GetVictimSteamId() uint64 {
...
func (x *CMsgGC_Match_Result_EventInfo) GetKillerSteamId() []uint64 {
	if x != nil {
...
func (x *CMsgGC_Match_Result_EventInfo) GetTime() int32 {
	if x != nil && x.Time != nil {
		return *x.Time
	}
	return 0
...
func (x *CMsgGC_Match_Result_EventInfo) GetBounty() int32 {
...
func (x *CMsgGC_DailyCompetitiveStatsRollup_Response_RankBucketEntry) Reset() {
	*x = CMsgGC_DailyCompetitiveStatsRollup_Response_RankBucketEntry{}
	mi := &file_tf_gcmessages_proto_msgTypes[199]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CMsgGC_DailyCompetitiveStatsRollup_Response_RankBucketEntry) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{147, 0}
}
...
type CMsgGCDataCenterPing_Update_PingEntry struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Name  *string                `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`  // data center name
	Ping  *uint32                `protobuf:"varint,2,opt,name=ping" json:"ping,omitempty"` // ping to the data center
...
func (x *CMsgGCDataCenterPing_Update_PingEntry) Reset() {
	*x = CMsgGCDataCenterPing_Update_PingEntry{}
	mi := &file_tf_gcmessages_proto_msgTypes[200]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *CMsgGCChangeMatchPlayerTeamsRequest_Member) Reset() {
	*x = CMsgGCChangeMatchPlayerTeamsRequest_Member{}
	mi := &file_tf_gcmessages_proto_msgTypes[201]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CMsgGCChangeMatchPlayerTeamsRequest_Member) Descriptor() ([]byte, []int) {
	return file_tf_gcmessages_proto_rawDescGZIP(), []int{168, 0}
}
...
const file_tf_gcmessages_proto_rawDesc = "" +
	"\n" +
	"\x13tf_gcmessages.proto\x1a\x13steammessages.proto\x1a\x15base_gcmessages.proto\"\xef\x06\n" +
	...
	"\x15spectator_server_name\x18\x1b \x01(\tR\x13spectatorServerName\x12%\n" +
	"\x0eserver_steamid\x18  \x01(\x06R\rserverSteamid\x12\x17\n" +
	...
	"\x03map\x18\x15 \x01(\tR\x03map\x12*\n" +
	"\x11game_server_token\x18\x1f \x01(\tR\x0fgameServerToken\x1a#\n" +
	"\x06Player\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\"]\n" +
	"\x11CMsgGSUserPlaying\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\x12\x17\n" +
	"\afake_ip\x18\x02 \x01(\aR\x06fakeIp\x12\x14\n" +
	"\x05token\x18\x03 \x01(\fR\x05token\"3\n" +
	"\x16CMsgGSDisconnectNotice\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\"y\n" +
	...
	"\tuser_name\x18\x03 \x01(\tR\buserName\"\xd8\x02\n" +
	"\x11CMsgTFWorldStatus\x12G\n" +
	"\x1dbeta_stress_test_event_active\x18\x01 \x01(\b:\x05falseR\x19betaStressTestEventActive\x12S\n" +
	"\x11event_match_group\x18\x02 \x01(\x0e2\x0e.ETFMatchGroup:\x17k_eTFMatchGroup_InvalidR\x0feventMatchGroup\x12-\n" +
	"\x11event_expire_time\x18\x03 \x01(\a:\x010R\x0feventExpireTime\x122\n" +
	"\x15active_client_version\x18\x04 \x01(\rR\x13activeClientVersion\x12B\n" +
	"\x15disabled_match_groups\x18\x05 \x03(\x0e2\x0e.ETFMatchGroupR\x13disabledMatchGroups\"\x80\x02\n" +
	...
	"\x10last_duel_status\x18\x06 \x01(\rR\x0elastDuelStatus\"g\n" +
	"\x0fCMsgTrackedStat\x12&\n" +
	"\x0ftracked_stat_id\x18\x01 \x01(\rR\rtrackedStatId\x12,\n" +
	"\x12tracked_stat_value\x18\x02 \x01(\x05R\x10trackedStatValue\"\x8d\x01\n" +
	...
	"\x10account_id_coach\x18\x01 \x01(\rR\x0eaccountIdCoach\"\xad\x02\n" +
	"\x1cCMsgTFQuickplay_ScoreServers\x12B\n" +
	"\aservers\x18\x01 \x03(\v2(.CMsgTFQuickplay_ScoreServers.ServerInfoR\aservers\x1a\xc8\x01\n" +
	"\n" +
	"ServerInfo\x12%\n" +
	...
	"\n" +
	"user_score\x18\x06 \x01(\x02R\tuserScore\"\xaa\x02\n" +
	"$CMsgTFQuickplay_ScoreServersResponse\x12J\n" +
	"\aservers\x18\x01 \x03(\v20.CMsgTFQuickplay_ScoreServersResponse.ServerInfoR\aservers\x1a\xb5\x01\n" +
	"\n" +
	"ServerInfo\x12%\n" +
	"\x0eserver_address\x18\x01 \x01(\rR\rserverAddress\x12\x1f\n" +
	"\vserver_port\x18\x02 \x01(\rR\n" +
	...
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\"\x88\x03\n" +
	...
	"\x1agame_server_identity_token\x18\x03 \x01(\tR\x17gameServerIdentityToken\x12I\n" +
	"\x06status\x18\x04 \x01(\x0e21.CMsgGC_GameServer_CreateIdentityResponse.EStatusR\x06status\"v\n" +
	"\aEStatus\x12\x1a\n" +
	...
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\"\xfa\x02\n" +
	"\x1eCMsgGC_GameServer_ListResponse\x12`\n" +
	"\x12owned_game_servers\x18\x01 \x03(\v22.CMsgGC_GameServer_ListResponse.GameServerIdentityR\x10ownedGameServers\x1a\xf5\x01\n" +
	...
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\"\xdb\x03\n" +
	"0CMsgGC_Client_UseServerModificationItem_Response\x12v\n" +
	"\rresponse_code\x18\x01 \x01(\x0e2Q.CMsgGC_Client_UseServerModificationItem_Response.EServerModificationItemResponseR\fresponseCode\"\xae\x02\n" +
	...
	"2kServerModificationItemResponse_EventAlreadyActive\x10\x05\"x\n" +
	"+CMsgGC_GameServer_UseServerModificationItem\x12I\n" +
	"\x11modification_type\x18\x01 \x01(\x0e2\x1c.EServerModificationItemTypeR\x10modificationType\"\xdd\x03\n" +
	"4CMsgGC_GameServer_UseServerModificationItem_Response\x12I\n" +
	"\x11modification_type\x18\x01 \x01(\x0e2\x1c.EServerModificationItemTypeR\x10modificationType\x12\x8d\x01\n" +
	"\x14server_response_code\x18\x02 \x01(\x0e2[.CMsgGC_GameServer_UseServerModificationItem_Response.EServerModificationItemServerResponseR\x12serverResponseCode\"\xc9\x01\n" +
	...
	"0kServerModificationItemServerResponse_VoteFailed\x10\x03\"|\n" +
	"/CMsgGC_GameServer_ServerModificationItemExpired\x12I\n" +
	"\x11modification_type\x18\x01 \x01(\x0e2\x1c.EServerModificationItemTypeR\x10modificationType\"\x8d\x01\n" +
	"(CMsgGC_GameServer_ServerModificationItem\x12I\n" +
	"\x11modification_type\x18\x01 \x01(\x0e2\x1c.EServerModificationItemTypeR\x10modificationType\x12\x16\n" +
	...
	"\blevel_id\x18\x03 \x01(\rR\alevelId\"\xf5\x05\n" +
	...
	"experience\x12H\n" +
	"\x0fplayer_criteria\x18\x10 \x01(\v2\x1f.CTFPerPlayerMatchCriteriaProtoR\x0eplayerCriteria\x126\n" +
	"\bactivity\x18\x11 \x01(\v2\x1a.CSOTFPartyMember.ActivityR\bactivity\x12#\n" +
	...
	"\rlobby_standby\x18\x16 \x01(\bR\flobbyStandby\x1a\xcf\x01\n" +
	"\bActivity\x12\x19\n" +
	"\blobby_id\x18\x01 \x01(\x06R\alobbyId\x12:\n" +
	"\x11lobby_match_group\x18\x02 \x01(\x0e2\x0e.ETFMatchGroupR\x0flobbyMatchGroup\x12-\n" +
	"\x12multiqueue_blocked\x18\x03 \x01(\bR\x11multiqueueBlocked\x12\x16\n" +
	"\x06online\x18\x04 \x01(\bR\x06online\x12%\n" +
	"\x0eclient_version\x18\x05 \x01(\rR\rclientVersion\"\xaf\x01\n" +
	"\x14TFPendingPartyMember\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x128\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1b.TFPendingPartyMember.EType:\aInvitedR\x04type\x12\x18\n" +
	"\ainviter\x18\x03 \x01(\x06R\ainviter\")\n" +
	"\x05EType\x12\v\n" +
	"\aInvited\x10\x00\x12\x13\n" +
	"\x0fRequestedToJoin\x10\x01\"\xac\x01\n" +
	"\x11TFSyncedMMUIState\x12M\n" +
	"\tmenu_step\x18\x01 \x01(\x0e2\x14.ETFSyncedMMMenuStep:\x1ak_eTFSyncedMMMenuStep_NoneR\bmenuStep\x12H\n" +
	"\vmatch_group\x18\x02 \x01(\x0e2\x0e.ETFMatchGroup:\x17k_eTFMatchGroup_InvalidR\n" +
	"matchGroup\"\xc3\x02\n" +
	...
	"\x15mvm_bootcamp_missions\x18\x10 \x03(\tR\x13mvmBootcampMissions\x12@\n" +
	"\x0fcasual_criteria\x18\f \x01(\v2\x17.CTFCasualMatchCriteriaR\x0ecasualCriteria\"F\n" +
	...
	"\x11mvm_squad_surplus\x18\x01 \x01(\bR\x0fmvmSquadSurplus\"\x89\x02\n" +
	"\x0fCTFPartyOptions\x12-\n" +
	"\x12overwrite_existing\x18\x01 \x01(\bR\x11overwriteExisting\x12B\n" +
	"\x0egroup_criteria\x18\x02 \x01(\v2\x1b.CTFGroupMatchCriteriaProtoR\rgroupCriteria\x12H\n" +
	"\x0fplayer_criteria\x18\x03 \x01(\v2\x1f.CTFPerPlayerMatchCriteriaProtoR\x0eplayerCriteria\x129\n" +
	"\x0eplayer_uistate\x18\x05 \x01(\v2\x12.TFSyncedMMUIStateR\rplayerUistate\"\\\n" +
	"\x13CMsgPartySetOptions\x12\x19\n" +
	"\bparty_id\x18\x01 \x01(\x06R\apartyId\x12*\n" +
	"\aoptions\x18\x02 \x01(\v2\x10.CTFPartyOptionsR\aoptions\"\x1d\n" +
	"\x1bCMsgPartySetOptionsResponse\"\x9b\x01\n" +
	"\x16CMsgPartyQueueForMatch\x12\x19\n" +
	"\bparty_id\x18\x01 \x01(\x06R\apartyId\x125\n" +
	"\rfinal_options\x18\x02 \x01(\v2\x10.CTFPartyOptionsR\ffinalOptions\x12/\n" +
	"\vmatch_group\x18\x03 \x01(\x0e2\x0e.ETFMatchGroupR\n" +
	"matchGroup\" \n" +
	"\x1eCMsgPartyQueueForMatchResponse\"[\n" +
	"\x18CMsgPartyQueueForStandby\x12\x19\n" +
	"\bparty_id\x18\x01 \x01(\x06R\apartyId\x12$\n" +
	"\x0eparty_lobby_id\x18\x02 \x01(\x06R\fpartyLobbyId\"\"\n" +
	" CMsgPartyQueueForStandbyResponse\"f\n" +
	"\x18CMsgPartyRemoveFromQueue\x12\x19\n" +
	"\bparty_id\x18\x01 \x01(\x06R\apartyId\x12/\n" +
	"\vmatch_group\x18\x02 \x01(\x0e2\x0e.ETFMatchGroupR\n" +
	"matchGroup\"\"\n" +
	...
	"\bparty_id\x18\x01 \x01(\x06R\apartyId\x12*\n" +
	"\x11pending_player_id\x18\x02 \x01(\x06R\x0fpendingPlayerId\"s\n" +
	"\x10CMsgPartyMMError\x12*\n" +
	"\x04type\x18\x01 \x01(\x0e2\x16.CMsgPartyMMError.TypeR\x04type\"3\n" +
	"\x04Type\x12\x16\n" +
	...
	"\x10CMsgPartyChatMsg\x12%\n" +
	"\x04type\x18\x01 \x01(\x0e2\x11.ETFPartyChatTypeR\x04type\x12\x19\n" +
	"\bactor_id\x18\x02 \x01(\x06R\aactorId\x12\x10\n" +
	"\x03msg\x18\x03 \x01(\tR\x03msg\"\xcc\x06\n" +
	"\n" +
	"CSOTFParty\x12\x1f\n" +
	"\bparty_id\x18\x01 \x01(\x04B\x04\x80\xa6\x1d\x01R\apartyId\x12\x1b\n" +
	"\tleader_id\x18\x02 \x01(\x06R\bleaderId\x12\x1d\n" +
	"\n" +
	"member_ids\x18\x03 \x03(\x06R\tmemberIds\x12+\n" +
	"\amembers\x18\r \x03(\v2\x11.CSOTFPartyMemberR\amembers\x12.\n" +
	"\x13associated_lobby_id\x18# \x01(\x04R\x11associatedLobbyId\x12O\n" +
	"\x1cassociated_lobby_match_group\x18( \x01(\x0e2\x0e.ETFMatchGroupR\x19associatedLobbyMatchGroup\x12E\n" +
	"\x12matchmaking_queues\x18+ \x03(\v2\x16.CSOTFParty.QueueEntryR\x11matchmakingQueues\x12B\n" +
	"\x0egroup_criteria\x18% \x01(\v2\x1b.CTFGroupMatchCriteriaProtoR\rgroupCriteria\x12,\n" +
	...
	"\x18ranked_low_priority_time\x18* \x01(\rR\x15rankedLowPriorityTime\x12:\n" +
	"\x0fleader_ui_state\x18, \x01(\v2\x12.TFSyncedMMUIStateR\rleaderUiState\x12>\n" +
	"\x0fpending_members\x18' \x03(\v2\x15.TFPendingPartyMemberR\x0ependingMembers\x1a^\n" +
	"\n" +
	"QueueEntry\x12/\n" +
	"\vmatch_group\x18\x01 \x01(\x0e2\x0e.ETFMatchGroupR\n" +
	"matchGroup\x12\x1f\n" +
	"\vqueued_time\x18\x02 \x01(\aR\n" +
	"queuedTime\"\x91\x02\n" +
	"\x10CSOTFPartyInvite\x12\x1f\n" +
	"\bgroup_id\x18\x01 \x01(\x04B\x04\x80\xa6\x1d\x01R\agroupId\x12\x18\n" +
	"\ainviter\x18\x02 \x01(\x06R\ainviter\x127\n" +
	"\amembers\x18\x04 \x03(\v2\x1d.CSOTFPartyInvite.PartyMemberR\amembers\x12*\n" +
	"\x04type\x18\x05 \x01(\x0e2\x16.CSOTFPartyInvite.TypeR\x04type\x1a'\n" +
	"\vPartyMember\x12\x18\n" +
	"\asteamid\x18\x02 \x01(\x06R\asteamid\"4\n" +
	"\x04Type\x12\x12\n" +
	"\x0ePENDING_INVITE\x10\x01\x12\x18\n" +
	"\x14PENDING_JOIN_REQUEST\x10\x02\"\xd3\x05\n" +
	"\x13CTFLobbyPlayerProto\x12\x14\n" +
	"\x02id\x18\x01 \x01(\x06B\x04\x80\xa6\x1d\x01R\x02id\x12\x1f\n" +
	"\x04team\x18\x03 \x01(\x0e2\v.TF_GC_TEAMR\x04team\x12F\n" +
	"\rconnect_state\x18\r \x01(\x0e2!.CTFLobbyPlayerProto.ConnectStateR\fconnectState\x12\x12\n" +
	...
	"badgeLevel\x12*\n" +
	"\x11last_connect_time\x18\x11 \x01(\rR\x0flastConnectTime\x12-\n" +
	"\x04type\x18\x13 \x01(\x0e2\x19.CTFLobbyPlayerProto.TypeR\x04type\x12+\n" +
	...
	"\x10OBSERVING_PLAYER\x10\x03\"g\n" +
	"\x13CTFLobbyInviteProto\x12\x1f\n" +
	"\blobby_id\x18\x01 \x01(\x06B\x04\x80\xa6\x1d\x01R\alobbyId\x12/\n" +
	"\vmatch_group\x18\x02 \x01(\x0e2\x0e.ETFMatchGroupR\n" +
	"matchGroup\"\xd2\a\n" +
	"\x14CSOTFGameServerLobby\x12\x1f\n" +
	"\blobby_id\x18\x01 \x01(\x04B\x04\x80\xa6\x1d\x01R\alobbyId\x12.\n" +
	"\amembers\x18\x02 \x03(\v2\x14.CTFLobbyPlayerProtoR\amembers\x12\x1e\n" +
	"\tserver_id\x18\x06 \x01(\x06:\x010R\bserverId\x12:\n" +
	"\x05state\x18\x04 \x01(\x0e2\x1b.CSOTFGameServerLobby.State:\aUNKNOWNR\x05state\x12\x18\n" +
	"\aconnect\x18\x05 \x01(\tR\aconnect\x12/\n" +
	"\n" +
	"game_state\x18\x16 \x01(\x0e2\x10.TF_GC_GameStateR\tgameState\x129\n" +
	...
	"\x10fixed_match_size\x18- \x01(\rR\x0efixedMatchSize\x12F\n" +
	"\fis_war_match\x18. \x01(\x0e2\x1e.CSOTFGameServerLobby.WarMatch:\x04NOPER\n" +
	"isWarMatch\x12+\n" +
	"\x12next_maps_for_vote\x18/ \x03(\rR\x0fnextMapsForVote\x12(\n" +
	"\x10lobby_mm_version\x180 \x01(\rR\x0elobbyMmVersion\x12=\n" +
	"\x0fpending_members\x181 \x03(\v2\x14.CTFLobbyPlayerProtoR\x0ependingMembers\".\n" +
	"\x05State\x12\v\n" +
	...
	"\x1eCMsgKickedFromMatchmakingQueue\"\xba\t\n" +
	...
	"\aplayers\x18\r \x03(\v2'.CMsgGameServerMatchmakingStatus.PlayerR\aplayers\x12/\n" +
	"\n" +
	"game_state\x18\x0e \x01(\x0e2\x10.TF_GC_GameStateR\tgameState\x12B\n" +
	"\x05event\x18\x0f \x01(\x0e2&.CMsgGameServerMatchmakingStatus.Event:\x04NoneR\x05event\x12\x19\n" +
	...
	"matchGroup\x12(\n" +
	"\x10lobby_mm_version\x18\x18 \x01(\rR\x0elobbyMmVersion\x1a}\n" +
	"\x06Player\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\x12X\n" +
	"\rconnect_state\x18\x02 \x01(\x0e23.CMsgGameServerMatchmakingStatus.PlayerConnectStateR\fconnectState\">\n" +
	...
	"\aplayers\x18\x01 \x03(\v2\x1a.CMsgMvMVictoryInfo.PlayerR\aplayers\x12\x1b\n" +
	"\ttour_name\x18\x02 \x01(\tR\btourName\x12!\n" +
	"\fmission_name\x18\x03 \x01(\tR\vmissionName\x1a\xab\x01\n" +
	"\x04Item\x12B\n" +
	"\fgrant_reason\x18\x01 \x01(\x0e2\x1f.CMsgMvMVictoryInfo.GrantReasonR\vgrantReason\x12\x1b\n" +
	"\titem_data\x18\x02 \x01(\fR\bitemData\x12B\n" +
	"\x1esquad_surplus_claimer_steam_id\x18\x03 \x01(\x06R\x1asquadSurplusClaimerSteamId\x1a\xf0\x02\n" +
	"\x06Player\x12\x19\n" +
	...
	"badgeLevel\x12.\n" +
	"\x13badge_progress_bits\x18\a \x01(\rR\x11badgeProgressBits\x12.\n" +
	"\x05items\x18\b \x03(\v2\x18.CMsgMvMVictoryInfo.ItemR\x05items\x12'\n" +
	...
	"\rversion_check\x18\x03 \x01(\rR\fversionCheck\"\xc5\x02\n" +
	...
	"\fmission_name\x18\x06 \x01(\tR\vmissionName\x120\n" +
	"\aplayers\x18\x02 \x03(\v2\x16.CMsgMvMVictory.PlayerR\aplayers\x12\x19\n" +
	...
	"\bparty_id\x18\x01 \x01(\x06R\apartyId\"\xf3\x01\n" +
	"\x13CMsgPlayerLeftMatch\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\x126\n" +
	"\fleave_reason\x18\x02 \x01(\x0e2\x13.TFMatchLeaveReasonR\vleaveReason\x12\x1f\n" +
	...
	"\x1bCMsgPlayerLeftMatchResponse\"\xcd\x02\n" +
	...
	"\x0ftarget_steam_id\x18\x03 \x01(\x06R\rtargetSteamId\x12)\n" +
	"\x06reason\x18\x04 \x01(\x0e2\x11.TFVoteKickReasonR\x06reason\x124\n" +
	...
	"\x0eengineer_count\x18\x1e \x01(\rR\rengineerCount\"\xba\x01\n" +
	"$CMsgUpdateHalloweenMerasmusLootLevel\x12F\n" +
	"\aplayers\x18\x01 \x03(\v2,.CMsgUpdateHalloweenMerasmusLootLevel.PlayerR\aplayers\x12%\n" +
	...
	"\x06war_id\x18\x01 \x01(\rR\x05warId\"\xbe\x01\n" +
	" CGCMsgGC_War_GlobalStatsResponse\x12L\n" +
	"\vside_scores\x18\x01 \x03(\v2+.CGCMsgGC_War_GlobalStatsResponse.SideScoreR\n" +
	"sideScores\x12\x15\n" +
	...
	"matchGroup\x121\n" +
	"\x14predicted_experience\x18\x02 \x01(\rR\x13predictedExperience\"\xb4\x03\n" +
	"\x0eCMsgTFXPSource\x126\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1c.CMsgTFXPSource.XPSourceTypeB\x04\x80\xa6\x1d\x01R\x04type\x12\x16\n" +
	...
	"\x15SOURCE_PRESTIGE_BONUS\x10\a\"D\n" +
	"\x17CMsgTFXPSourceBreakdown\x12)\n" +
	"\asources\x18\x01 \x03(\v2\x0f.CMsgTFXPSourceR\asources\"U\n" +
	"\x10CMsgTFClientInit\x12%\n" +
	"\x0eclient_version\x18\x01 \x01(\rR\rclientVersion\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\x05R\blanguage\"\x8d\x04\n" +
	...
	"\x0fexpiration_time\x18\x03 \x01(\aR\x0eexpirationTime\x12T\n" +
	"\x04type\x18\x04 \x01(\x0e2$.CMsgGCNotification.NotificationType:\x1aNOTIFICATION_CUSTOM_STRINGR\x04type\x12/\n" +
	...
	"\rnotifications\x18\x01 \x03(\v2\x13.CMsgGCNotificationR\rnotifications\"e\n" +
	"\x1bCMsgNotificationAcknowledge\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12'\n" +
	"\x0fnotification_id\x18\x02 \x01(\x04R\x0enotificationId\"\"\n" +
	" CMsgNotificationAcknowledgeReply\"\x87\x0e\n" +
	...
	"matchGroup\x123\n" +
	"\x06status\x18\x03 \x01(\x0e2\x1b.CMsgGC_Match_Result.StatusR\x06status\x12\x1a\n" +
	...
	"\tgame_type\x18\t \x01(\r:\x010R\bgameType\x125\n" +
	"\aplayers\x18\n" +
	" \x03(\v2\x1b.CMsgGC_Match_Result.PlayerR\aplayers\x12\x1d\n" +
	"\n" +
	"win_reason\x18\r \x01(\rR\twinReason\x12\x14\n" +
	"\x05flags\x18\x0e \x01(\rR\x05flags\x12\x12\n" +
	"\x04bots\x18\x10 \x01(\rR\x04bots\x126\n" +
	"\x06events\x18\x12 \x03(\v2\x1e.CMsgGC_Match_Result.EventInfoR\x06events\x1a\x9d\x06\n" +
	"\x06Player\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\x12*\n" +
	...
	"\rsupport_medal\x18\x14 \x01(\rR\fsupportMedal\x122\n" +
	"\fxp_breakdown\x18\x15 \x03(\v2\x0f.CMsgTFXPSourceR\vxpBreakdown\x12\x1d\n" +
	"\n" +
	"leave_time\x18\x16 \x01(\rR\tleaveTime\x126\n" +
	"\fleave_reason\x18\x17 \x01(\x0e2\x13.TFMatchLeaveReasonR\vleaveReason\x12!\n" +
	"\fconnect_time\x18\x18 \x01(\rR\vconnectTime\x12\"\n" +
	"\rtime_on_class\x18\x19 \x03(\x02R\vtimeOnClass\x12\x1f\n" +
	"\vgraph_kills\x18\x1a \x03(\x02R\n" +
	"graphKills\x12!\n" +
	"\fgraph_deaths\x18\x1b \x03(\x02R\vgraphDeaths\x1a\xaf\x02\n" +
	"\tEventInfo\x12_\n" +
	"\n" +
	"event_type\x18\x01 \x01(\x0e2(.CMsgGC_Match_Result.EventInfo.EventType:\x16EVENT_TYPE_KILL_PLAYERR\teventType\x12&\n" +
	"\x0fvictim_steam_id\x18\x02 \x01(\x06R\rvictimSteamId\x12&\n" +
	"\x0fkiller_steam_id\x18\x03 \x03(\x06R\rkillerSteamId\x12\x12\n" +
	"\x04time\x18\x04 \x01(\x05R\x04time\x12\x16\n" +
	"\x06bounty\x18\x05 \x01(\x05R\x06bounty\"E\n" +
	"\tEventType\x12\x1a\n" +
	"\x16EVENT_TYPE_KILL_PLAYER\x10\x00\x12\x1c\n" +
	"\x18EVENT_TYPE_CAPTURE_POINT\x10\x01\"\xb6\x01\n" +
	"\x06Status\x12\x13\n" +
	...
	"\x1bCMsgGC_Match_ResultResponse\"E\n" +
	"\x19CEconItemPreviewDataBlock\x12(\n" +
	"\beconitem\x18\x01 \x01(\v2\f.CSOEconItemR\beconitem\"\x91\x01\n" +
	...
	"\aparam_m\x18\x04 \x01(\x04R\x06paramM\"f\n" +
	",CMsgGC_Client2GCEconPreviewDataBlockResponse\x126\n" +
	"\biteminfo\x18\x01 \x01(\v2\x1a.CEconItemPreviewDataBlockR\biteminfo\"\xc4\x06\n" +
	...
	"\x0frating_tertiary\x18\x05 \x01(\rR\x0eratingTertiary\"\x9e\x01\n" +
	"\x1eCMsgGC_TFVoteKickPlayerRequest\x12\x1b\n" +
	"\ttarget_id\x18\x02 \x01(\x04R\btargetId\x12\x19\n" +
	"\bvoter_id\x18\x03 \x01(\x04R\avoterId\x12)\n" +
	"\x06reason\x18\x04 \x01(\x0e2\x11.TFVoteKickReasonR\x06reason\x12\x19\n" +
	...
	"\"CMsgGC_DailyCompetitiveStatsRollup\"\x93\x04\n" +
	"+CMsgGC_DailyCompetitiveStatsRollup_Response\x12X\n" +
	"\brankdata\x18\x01 \x03(\v2<.CMsgGC_DailyCompetitiveStatsRollup_Response.RankBucketEntryR\brankdata\x1a\x89\x03\n" +
	...
	"avgSupport\x12#\n" +
	"\rstdev_support\x18\f \x01(\rR\fstdevSupport\"\x81\x02\n" +
	"\x13CMsgGC_ReportPlayer\x12*\n" +
	"\x11account_id_target\x18\x01 \x01(\rR\x0faccountIdTarget\x124\n" +
	"\x06reason\x18\x02 \x01(\x0e2\x1c.CMsgGC_ReportPlayer.EReasonR\x06reason\"\x87\x01\n" +
	"\aEReason\x12\x13\n" +
	...
	"\fhealth_ratio\x18\x02 \x01(\x02R\vhealthRatio\"y\n" +
	"$CMsgGCMatchGroupDataCenterPopulation\x12Q\n" +
	"\x16data_center_population\x18\x01 \x03(\v2\x1b.CMsgGCDataCenterPopulationR\x14dataCenterPopulation\"\xae\x01\n" +
	"\x1dCMsgGCMatchMakerStatsResponse\x12\x1b\n" +
	"\tmap_count\x18\x01 \x03(\rR\bmapCount\x12p\n" +
	"!matchgroup_data_center_population\x18\x02 \x03(\v2%.CMsgGCMatchGroupDataCenterPopulationR\x1ematchgroupDataCenterPopulation\"b\n" +
	"\x16CMsgGCMatchHistoryLoad\x12H\n" +
	"\vmatch_group\x18\x01 \x01(\x0e2\x0e.ETFMatchGroup:\x17k_eTFMatchGroup_InvalidR\n" +
	"matchGroup\"\xaf\x02\n" +
	"\x1bCMsgGCDataCenterPing_Update\x12B\n" +
	"\bpingdata\x18\x01 \x03(\v2&.CMsgGCDataCenterPing_Update.PingEntryR\bpingdata\x1a\x81\x01\n" +
	"\tPingEntry\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04ping\x18\x02 \x01(\rR\x04ping\x12L\n" +
	"\vping_status\x18\x03 \x01(\x0e2#.CMsgGCDataCenterPing_Update.Status:\x06NormalR\n" +
	"pingStatus\"H\n" +
	"\x06Status\x12\v\n" +
	"\aInvalid\x10\x00\x12\n" +
	"\n" +
	...
	"\x13CMsgGCSurveyRequest\x128\n" +
	"\rquestion_type\x18\x01 \x01(\x0e2\x13.SurveyQuestionTypeR\fquestionType\x12\x19\n" +
	"\bmatch_id\x18\x02 \x01(\x04R\amatchId\"\x87\x01\n" +
	"\x14CMsgGCSurveyResponse\x128\n" +
	"\rquestion_type\x18\x01 \x01(\x0e2\x13.SurveyQuestionTypeR\fquestionType\x12\x19\n" +
	...
	"\blobby_id\x18\x02 \x01(\x04R\alobbyId\x12C\n" +
	"\x06member\x18\x03 \x03(\v2+.CMsgGCChangeMatchPlayerTeamsRequest.MemberR\x06member\x1a`\n" +
	"\x06Member\x12\x1b\n" +
	"\tmember_id\x18\x01 \x01(\x04R\bmemberId\x129\n" +
	"\bnew_team\x18\x02 \x01(\x0e2\v.TF_GC_TEAM:\x11TF_GC_TEAM_NOTEAMR\anewTeam\"@\n" +
	...
	"giveCredit\x12:\n" +
	"\vunlock_node\x18\x03 \x01(\v2\x19.CMsgGCQuestMapUnlockNodeR\n" +
	"unlockNode\"N\n" +
	...
	"\fnotification\x18\x01 \x01(\v2\x13.CMsgGCNotificationR\fnotification*\x994\n" +
	"\bETFGCMsg\x12\x1a\n" +
	...
	"\x15k_EMsgGCParty_MMError\x10\xba3\x12#\n" +
	"\x1ek_EMsgGC_GameServer_UpdateData\x10\xbb3\x12\x1d\n" +
...
var file_tf_gcmessages_proto_enumTypes = make([]protoimpl.EnumInfo, 30)
var file_tf_gcmessages_proto_msgTypes = make([]protoimpl.MessageInfo, 202)
var file_tf_gcmessages_proto_goTypes = []any{
	...
	(CMsgGC_Match_Result_EventInfo_EventType)(0),                                                    // 27: CMsgGC_Match_Result.EventInfo.EventType
	(CMsgGC_ReportPlayer_EReason)(0),                                                                // 28: CMsgGC_ReportPlayer.EReason
	(CMsgGCDataCenterPing_Update_Status)(0),                                                         // 29: CMsgGCDataCenterPing_Update.Status
	(*CMsgGameServerData)(nil),                                                                      // 30: CMsgGameServerData
	(*CMsgGSUserPlaying)(nil),                                                                       // 31: CMsgGSUserPlaying
	(*CMsgGSDisconnectNotice)(nil),                                                                  // 32: CMsgGSDisconnectNotice
	(*CMsgTFGoldenWrenchBroadcast)(nil),                                                             // 33: CMsgTFGoldenWrenchBroadcast
	(*CMsgTFSaxxyBroadcast)(nil),                                                                    // 34: CMsgTFSaxxyBroadcast
	(*CMsgGCTFSpecificItemBroadcast)(nil),                                                           // 35: CMsgGCTFSpecificItemBroadcast
	(*CMsgTFWorldStatus)(nil),                                                                       // 36: CMsgTFWorldStatus
	(*CSOTFDuelSummary)(nil),                                                                        // 37: CSOTFDuelSummary
	(*CMsgTrackedStat)(nil),                                                                         // 38: CMsgTrackedStat
	(*CSOTFMapContribution)(nil),                                                                    // 39: CSOTFMapContribution
	(*CMsgTFFreeTrialChooseMostHelpfulFriend)(nil),                                                  // 40: CMsgTFFreeTrialChooseMostHelpfulFriend
	(*CMsgTFRequestTF2Friends)(nil),                                                                 // 41: CMsgTFRequestTF2Friends
	(*CMsgTFRequestTF2FriendsResponse)(nil),                                                         // 42: CMsgTFRequestTF2FriendsResponse
	(*CSOTFPlayerInfo)(nil),                                                                         // 43: CSOTFPlayerInfo
	(*CMsgTFThankedBySomeone)(nil),                                                                  // 44: CMsgTFThankedBySomeone
	(*CMsgTFThankedSomeone)(nil),                                                                    // 45: CMsgTFThankedSomeone
	(*CMsgTFFreeTrialConvertedToPremium)(nil),                                                       // 46: CMsgTFFreeTrialConvertedToPremium
	(*CMsgSaxxyAwarded)(nil),                                                                        // 47: CMsgSaxxyAwarded
	(*CMsgReplaySubmitContestEntry)(nil),                                                            // 48: CMsgReplaySubmitContestEntry
	(*CMsgReplaySubmitContestEntryResponse)(nil),                                                    // 49: CMsgReplaySubmitContestEntryResponse
	(*CReplayCachedContestData)(nil),                                                                // 50: CReplayCachedContestData
	(*CMsgTFCoaching_AddToCoaches)(nil),                                                             // 51: CMsgTFCoaching_AddToCoaches
	(*CMsgTFCoaching_RemoveFromCoaches)(nil),                                                        // 52: CMsgTFCoaching_RemoveFromCoaches
	(*CMsgTFCoaching_FindCoach)(nil),                                                                // 53: CMsgTFCoaching_FindCoach
	(*CMsgTFCoaching_FindCoachResponse)(nil),                                                        // 54: CMsgTFCoaching_FindCoachResponse
	(*CMsgTFCoaching_AskCoach)(nil),                                                                 // 55: CMsgTFCoaching_AskCoach
	(*CMsgTFCoaching_AskCoachResponse)(nil),                                                         // 56: CMsgTFCoaching_AskCoachResponse
	(*CMsgTFCoaching_CoachJoinGame)(nil),                                                            // 57: CMsgTFCoaching_CoachJoinGame
	(*CMsgTFCoaching_CoachJoining)(nil),                                                             // 58: CMsgTFCoaching_CoachJoining
	(*CMsgTFCoaching_CoachJoined)(nil),                                                              // 59: CMsgTFCoaching_CoachJoined
	(*CMsgTFCoaching_LikeCurrentCoach)(nil),                                                         // 60: CMsgTFCoaching_LikeCurrentCoach
	(*CMsgTFCoaching_RemoveCurrentCoach)(nil),                                                       // 61: CMsgTFCoaching_RemoveCurrentCoach
	(*CMsgTFQuickplay_ScoreServers)(nil),                                                            // 62: CMsgTFQuickplay_ScoreServers
	(*CMsgTFQuickplay_ScoreServersResponse)(nil),                                                    // 63: CMsgTFQuickplay_ScoreServersResponse
	(*CMsgTFQuickplay_PlayerJoining)(nil),                                                           // 64: CMsgTFQuickplay_PlayerJoining
	(*CMsgGC_GameServer_LevelInfo)(nil),                                                             // 65: CMsgGC_GameServer_LevelInfo
	(*CMsgGC_GameServer_AuthChallenge)(nil),                                                         // 66: CMsgGC_GameServer_AuthChallenge
	(*CMsgGC_GameServer_AuthResult)(nil),                                                            // 67: CMsgGC_GameServer_AuthResult
	(*CMsgGC_GameServer_AuthChallengeResponse)(nil),                                                 // 68: CMsgGC_GameServer_AuthChallengeResponse
	(*CMsgGC_GameServer_CreateIdentity)(nil),                                                        // 69: CMsgGC_GameServer_CreateIdentity
	(*CMsgGC_GameServer_CreateIdentityResponse)(nil),                                                // 70: CMsgGC_GameServer_CreateIdentityResponse
	(*CMsgGC_GameServer_List)(nil),                                                                  // 71: CMsgGC_GameServer_List
	(*CMsgGC_GameServer_ListResponse)(nil),                                                          // 72: CMsgGC_GameServer_ListResponse
	(*CMsgGC_GameServer_ResetIdentity)(nil),                                                         // 73: CMsgGC_GameServer_ResetIdentity
	(*CMsgGC_GameServer_ResetIdentityResponse)(nil),                                                 // 74: CMsgGC_GameServer_ResetIdentityResponse
	(*CMsgGC_GameServer_AckPolicy)(nil),                                                             // 75: CMsgGC_GameServer_AckPolicy
	(*CMsgGC_GameServer_AckPolicyResponse)(nil),                                                     // 76: CMsgGC_GameServer_AckPolicyResponse
	(*CMsgGC_Client_UseServerModificationItem)(nil),                                                 // 77: CMsgGC_Client_UseServerModificationItem
	(*CMsgGC_Client_UseServerModificationItem_Response)(nil),                                        // 78: CMsgGC_Client_UseServerModificationItem_Response
	(*CMsgGC_GameServer_UseServerModificationItem)(nil),                                             // 79: CMsgGC_GameServer_UseServerModificationItem
	(*CMsgGC_GameServer_UseServerModificationItem_Response)(nil),                                    // 80: CMsgGC_GameServer_UseServerModificationItem_Response
	(*CMsgGC_GameServer_ServerModificationItemExpired)(nil),                                         // 81: CMsgGC_GameServer_ServerModificationItemExpired
	(*CMsgGC_GameServer_ServerModificationItem)(nil),                                                // 82: CMsgGC_GameServer_ServerModificationItem
	(*CMsgGC_Halloween_ReservedItem)(nil),                                                           // 83: CMsgGC_Halloween_ReservedItem
	(*CMsgGC_Halloween_GrantItem)(nil),                                                              // 84: CMsgGC_Halloween_GrantItem
	(*CMsgGC_Halloween_GrantItemResponse)(nil),                                                      // 85: CMsgGC_Halloween_GrantItemResponse
	(*CMsgGC_Halloween_ItemClaimed)(nil),                                                            // 86: CMsgGC_Halloween_ItemClaimed
	(*CMsgGC_PickupItemEligibility_Query)(nil),                                                      // 87: CMsgGC_PickupItemEligibility_Query
	(*CMsgGC_PickupItemEligibility_QueryResponse)(nil),                                              // 88: CMsgGC_PickupItemEligibility_QueryResponse
	(*CSOTFPartyMember)(nil),                                                                        // 89: CSOTFPartyMember
	(*TFPendingPartyMember)(nil),                                                                    // 90: TFPendingPartyMember
	(*TFSyncedMMUIState)(nil),                                                                       // 91: TFSyncedMMUIState
	(*CTFGroupMatchCriteriaProto)(nil),                                                              // 92: CTFGroupMatchCriteriaProto
	(*CTFCasualMatchCriteria)(nil),                                                                  // 93: CTFCasualMatchCriteria
	(*CTFPerPlayerMatchCriteriaProto)(nil),                                                          // 94: CTFPerPlayerMatchCriteriaProto
	(*CTFPartyOptions)(nil),                                                                         // 95: CTFPartyOptions
	(*CMsgPartySetOptions)(nil),                                                                     // 96: CMsgPartySetOptions
	(*CMsgPartySetOptionsResponse)(nil),                                                             // 97: CMsgPartySetOptionsResponse
	(*CMsgPartyQueueForMatch)(nil),                                                                  // 98: CMsgPartyQueueForMatch
	(*CMsgPartyQueueForMatchResponse)(nil),                                                          // 99: CMsgPartyQueueForMatchResponse
	(*CMsgPartyQueueForStandby)(nil),                                                                // 100: CMsgPartyQueueForStandby
	(*CMsgPartyQueueForStandbyResponse)(nil),                                                        // 101: CMsgPartyQueueForStandbyResponse
	(*CMsgPartyRemoveFromQueue)(nil),                                                                // 102: CMsgPartyRemoveFromQueue
	(*CMsgPartyRemoveFromQueueResponse)(nil),                                                        // 103: CMsgPartyRemoveFromQueueResponse
	(*CMsgPartyRemoveFromStandbyQueue)(nil),                                                         // 104: CMsgPartyRemoveFromStandbyQueue
	(*CMsgPartyRemoveFromStandbyQueueResponse)(nil),                                                 // 105: CMsgPartyRemoveFromStandbyQueueResponse
	(*CMsgPartyInvitePlayer)(nil),                                                                   // 106: CMsgPartyInvitePlayer
	(*CMsgPartyRequestJoinPlayer)(nil),                                                              // 107: CMsgPartyRequestJoinPlayer
	(*CMsgPartyClearPendingPlayer)(nil),                                                             // 108: CMsgPartyClearPendingPlayer
	(*CMsgPartyMMError)(nil),                                                                        // 109: CMsgPartyMMError
	(*CMsgPartyClearPendingPlayerResponse)(nil),                                                     // 110: CMsgPartyClearPendingPlayerResponse
	(*CMsgPartyClearOtherPartyRequest)(nil),                                                         // 111: CMsgPartyClearOtherPartyRequest
	(*CMsgPartyClearOtherPartyRequestResponse)(nil),                                                 // 112: CMsgPartyClearOtherPartyRequestResponse
	(*CMsgPartyPromoteToLeader)(nil),                                                                // 113: CMsgPartyPromoteToLeader
	(*CMsgPartyKickMember)(nil),                                                                     // 114: CMsgPartyKickMember
	(*CMsgPartySendChat)(nil),                                                                       // 115: CMsgPartySendChat
	(*CMsgPartyChatMsg)(nil),                                                                        // 116: CMsgPartyChatMsg
	(*CSOTFParty)(nil),                                                                              // 117: CSOTFParty
	(*CSOTFPartyInvite)(nil),                                                                        // 118: CSOTFPartyInvite
	(*CTFLobbyPlayerProto)(nil),                                                                     // 119: CTFLobbyPlayerProto
	(*CTFLobbyInviteProto)(nil),                                                                     // 120: CTFLobbyInviteProto
	(*CSOTFGameServerLobby)(nil),                                                                    // 121: CSOTFGameServerLobby
	(*CMsgExitMatchmaking)(nil),                                                                     // 122: CMsgExitMatchmaking
	(*CMsgAcceptLobbyInvite)(nil),                                                                   // 123: CMsgAcceptLobbyInvite
	(*CMsgAcceptLobbyInviteReply)(nil),                                                              // 124: CMsgAcceptLobbyInviteReply
	(*CMsgMatchmakingSearchCountRequest)(nil),                                                       // 125: CMsgMatchmakingSearchCountRequest
	(*CMsgMatchmakingSearchCountResponse)(nil),                                                      // 126: CMsgMatchmakingSearchCountResponse
	(*CMsgKickedFromMatchmakingQueue)(nil),                                                          // 127: CMsgKickedFromMatchmakingQueue
	(*CMsgGameServerMatchmakingStatus)(nil),                                                         // 128: CMsgGameServerMatchmakingStatus
	(*CMsgMatchmakingProgress)(nil),                                                                 // 129: CMsgMatchmakingProgress
	(*CMsgMvMVictoryInfo)(nil),                                                                      // 130: CMsgMvMVictoryInfo
	(*CGCMsgTFHelloResponse)(nil),                                                                   // 131: CGCMsgTFHelloResponse
	(*CGCMsgTFSync)(nil),                                                                            // 132: CGCMsgTFSync
	(*CGCMsgTFSyncEx)(nil),                                                                          // 133: CGCMsgTFSyncEx
	(*CMsgMvMVictory)(nil),                                                                          // 134: CMsgMvMVictory
	(*CMsgMvMMannUpVictoryReply)(nil),                                                               // 135: CMsgMvMMannUpVictoryReply
	(*CMsgGameServerKickingLobby)(nil),                                                              // 136: CMsgGameServerKickingLobby
	(*CMsgGameServerKickingLobbyResponse)(nil),                                                      // 137: CMsgGameServerKickingLobbyResponse
	(*CMsgLeaveGameAndPrepareToJoinParty)(nil),                                                      // 138: CMsgLeaveGameAndPrepareToJoinParty
	(*CMsgPlayerLeftMatch)(nil),                                                                     // 139: CMsgPlayerLeftMatch
	(*CMsgPlayerLeftMatchResponse)(nil),                                                             // 140: CMsgPlayerLeftMatchResponse
	(*CMsgProcessMatchVoteKick)(nil),                                                                // 141: CMsgProcessMatchVoteKick
	(*CMsgProcessMatchVoteKickResponse)(nil),                                                        // 142: CMsgProcessMatchVoteKickResponse
	(*CMsgHalloween_ServerBossEvent)(nil),                                                           // 143: CMsgHalloween_ServerBossEvent
	(*CMsgHalloween_Merasmus2012)(nil),                                                              // 144: CMsgHalloween_Merasmus2012
	(*CMsgUpdateHalloweenMerasmusLootLevel)(nil),                                                    // 145: CMsgUpdateHalloweenMerasmusLootLevel
	(*CAttribute_String)(nil),                                                                       // 146: CAttribute_String
	(*CAttribute_DynamicRecipeComponent)(nil),                                                       // 147: CAttribute_DynamicRecipeComponent
	(*CAttribute_DynamicRecipeComponent_COMPAT_NEVER_SERIALIZE_THIS_OUT)(nil),                       // 148: CAttribute_DynamicRecipeComponent_COMPAT_NEVER_SERIALIZE_THIS_OUT
	(*CAttribute_ItemSlotCriteria)(nil),                                                             // 149: CAttribute_ItemSlotCriteria
	(*CMsgSetItemSlotAttribute)(nil),                                                                // 150: CMsgSetItemSlotAttribute
	(*CSOWarData)(nil),                                                                              // 151: CSOWarData
	(*CGCMsgGC_War_IndividualUpdate)(nil),                                                           // 152: CGCMsgGC_War_IndividualUpdate
	(*CGCMsgGC_War_JoinWar)(nil),                                                                    // 153: CGCMsgGC_War_JoinWar
	(*CGCMsgGC_War_RequestGlobalStats)(nil),                                                         // 154: CGCMsgGC_War_RequestGlobalStats
	(*CGCMsgGC_War_GlobalStatsResponse)(nil),                                                        // 155: CGCMsgGC_War_GlobalStatsResponse
	(*CGCMsgGC_PlayerDuckLeaderboard_IndividualUpdate)(nil),                                         // 156: CGCMsgGC_PlayerDuckLeaderboard_IndividualUpdate
	(*CAttribute_WorldItemPlacement)(nil),                                                           // 157: CAttribute_WorldItemPlacement
	(*CGCMsg_WorldItemPlacement_Update)(nil),                                                        // 158: CGCMsg_WorldItemPlacement_Update
	(*CMsgAcknowledgeXP)(nil),                                                                       // 159: CMsgAcknowledgeXP
	(*CMsgTFXPSource)(nil),                                                                          // 160: CMsgTFXPSource
	(*CMsgTFXPSourceBreakdown)(nil),                                                                 // 161: CMsgTFXPSourceBreakdown
	(*CMsgTFClientInit)(nil),                                                                        // 162: CMsgTFClientInit
	(*CMsgGCNotification)(nil),                                                                      // 163: CMsgGCNotification
	(*CMsgGCNotificationQueue)(nil),                                                                 // 164: CMsgGCNotificationQueue
	(*CMsgNotificationAcknowledge)(nil),                                                             // 165: CMsgNotificationAcknowledge
	(*CMsgNotificationAcknowledgeReply)(nil),                                                        // 166: CMsgNotificationAcknowledgeReply
	(*CMsgGC_Match_Result)(nil),                                                                     // 167: CMsgGC_Match_Result
	(*CMsgGC_Match_ResultResponse)(nil),                                                             // 168: CMsgGC_Match_ResultResponse
	(*CEconItemPreviewDataBlock)(nil),                                                               // 169: CEconItemPreviewDataBlock
	(*CMsgGC_Client2GCEconPreviewDataBlockRequest)(nil),                                             // 170: CMsgGC_Client2GCEconPreviewDataBlockRequest
	(*CMsgGC_Client2GCEconPreviewDataBlockResponse)(nil),                                            // 171: CMsgGC_Client2GCEconPreviewDataBlockResponse
	(*CSOTFLadderPlayerStats)(nil),                                                                  // 172: CSOTFLadderPlayerStats
	(*CSOTFRatingData)(nil),                                                                         // 173: CSOTFRatingData
	(*CMsgGC_TFVoteKickPlayerRequest)(nil),                                                          // 174: CMsgGC_TFVoteKickPlayerRequest
	(*CMsgGC_VoteKickPlayerRequestResponse)(nil),                                                    // 175: CMsgGC_VoteKickPlayerRequestResponse
	(*CMsgGC_DailyCompetitiveStatsRollup)(nil),                                                      // 176: CMsgGC_DailyCompetitiveStatsRollup
	(*CMsgGC_DailyCompetitiveStatsRollup_Response)(nil),                                             // 177: CMsgGC_DailyCompetitiveStatsRollup_Response
	(*CMsgGC_ReportPlayer)(nil),                                                                     // 178: CMsgGC_ReportPlayer
	(*CSOTFMatchResultPlayerStats)(nil),                                                             // 179: CSOTFMatchResultPlayerStats
	(*CMsgGCRequestMatchMakerStats)(nil),                                                            // 180: CMsgGCRequestMatchMakerStats
	(*CMsgGCDataCenterPopulation)(nil),                                                              // 181: CMsgGCDataCenterPopulation
	(*CMsgGCMatchGroupDataCenterPopulation)(nil),                                                    // 182: CMsgGCMatchGroupDataCenterPopulation
	(*CMsgGCMatchMakerStatsResponse)(nil),                                                           // 183: CMsgGCMatchMakerStatsResponse
	(*CMsgGCMatchHistoryLoad)(nil),                                                                  // 184: CMsgGCMatchHistoryLoad
	(*CMsgGCDataCenterPing_Update)(nil),                                                             // 185: CMsgGCDataCenterPing_Update
	(*CMsgGC_KickPlayerFromLobby)(nil),                                                              // 186: CMsgGC_KickPlayerFromLobby
	(*CMsgGCSurveyRequest)(nil),                                                                     // 187: CMsgGCSurveyRequest
	(*CMsgGCSurveyResponse)(nil),                                                                    // 188: CMsgGCSurveyResponse
	(*CSOQuestMapNode)(nil),                                                                         // 189: CSOQuestMapNode
	(*CSOQuest)(nil),                                                                                // 190: CSOQuest
	(*CSOQuestMapRewardPurchase)(nil),                                                               // 191: CSOQuestMapRewardPurchase
	(*CMsgGCQuestIdentify)(nil),                                                                     // 192: CMsgGCQuestIdentify
	(*CMsgGCQuestDevGive)(nil),                                                                      // 193: CMsgGCQuestDevGive
	(*CMsgGCQuestNodeTurnIn)(nil),                                                                   // 194: CMsgGCQuestNodeTurnIn
	(*CMsgGCQuestMapUnlockNode)(nil),                                                                // 195: CMsgGCQuestMapUnlockNode
	(*CMsgGCNewMatchForLobbyRequest)(nil),                                                           // 196: CMsgGCNewMatchForLobbyRequest
	(*CMsgGCNewMatchForLobbyResponse)(nil),                                                          // 197: CMsgGCNewMatchForLobbyResponse
	(*CMsgGCChangeMatchPlayerTeamsRequest)(nil),                                                     // 198: CMsgGCChangeMatchPlayerTeamsRequest
	(*CMsgGCChangeMatchPlayerTeamsResponse)(nil),                                                    // 199: CMsgGCChangeMatchPlayerTeamsResponse
	(*CMsgGCQuestComplete_Debug)(nil),                                                               // 200: CMsgGCQuestComplete_Debug
	(*CMsgGCQuestMap_Debug)(nil),                                                                    // 201: CMsgGCQuestMap_Debug
	(*CMsgGCQuestMapPurchaseReward)(nil),                                                            // 202: CMsgGCQuestMapPurchaseReward
	(*CMsgGCQuestResponse)(nil),                                                                     // 203: CMsgGCQuestResponse
	(*CMsgGCSetDisablePartyQuestProgress)(nil),                                                      // 204: CMsgGCSetDisablePartyQuestProgress
	(*CMsgQuestProgressReport)(nil),                                                                 // 205: CMsgQuestProgressReport
	(*CMsgConsumePaintkit)(nil),                                                                     // 206: CMsgConsumePaintkit
	(*CMsgPainkitDevGrant)(nil),                                                                     // 207: CMsgPainkitDevGrant
	(*GCQuestStrangeEvent)(nil),                                                                     // 208: GCQuestStrangeEvent
	(*CMsgSDRTicket)(nil),                                                                           // 209: CMsgSDRTicket
	(*CMsgAuthorizeServerItemRetrieval)(nil),                                                        // 210: CMsgAuthorizeServerItemRetrieval
	(*CMsgGCToGCSendAccountBannedNotifications)(nil),                                                // 211: CMsgGCToGCSendAccountBannedNotifications
	(*CMsgGCToGCSendNotification)(nil),                                                              // 212: CMsgGCToGCSendNotification
	(*CMsgGameServerData_Player)(nil),                                                               // 213: CMsgGameServerData.Player
	(*CMsgTFQuickplay_ScoreServers_ServerInfo)(nil),                                                 // 214: CMsgTFQuickplay_ScoreServers.ServerInfo
	(*CMsgTFQuickplay_ScoreServersResponse_ServerInfo)(nil),                                         // 215: CMsgTFQuickplay_ScoreServersResponse.ServerInfo
	(*CMsgGC_GameServer_ListResponse_GameServerIdentity)(nil),                                       // 216: CMsgGC_GameServer_ListResponse.GameServerIdentity
	(*CSOTFPartyMember_Activity)(nil),                                                               // 217: CSOTFPartyMember.Activity
	(*CSOTFParty_QueueEntry)(nil),                                                                   // 218: CSOTFParty.QueueEntry
	(*CSOTFPartyInvite_PartyMember)(nil),                                                            // 219: CSOTFPartyInvite.PartyMember
	(*CMsgGameServerMatchmakingStatus_Player)(nil),                                                  // 220: CMsgGameServerMatchmakingStatus.Player
	(*CMsgMvMVictoryInfo_Item)(nil),                                                                 // 221: CMsgMvMVictoryInfo.Item
	(*CMsgMvMVictoryInfo_Player)(nil),                                                               // 222: CMsgMvMVictoryInfo.Player
	(*CMsgMvMVictory_Player)(nil),                                                                   // 223: CMsgMvMVictory.Player
	(*CMsgProcessMatchVoteKick_Vote)(nil),                                                           // 224: CMsgProcessMatchVoteKick.Vote
	(*CMsgUpdateHalloweenMerasmusLootLevel_Player)(nil),                                             // 225: CMsgUpdateHalloweenMerasmusLootLevel.Player
	(*CGCMsgGC_War_GlobalStatsResponse_SideScore)(nil),                                              // 226: CGCMsgGC_War_GlobalStatsResponse.SideScore
	(*CMsgGC_Match_Result_Player)(nil),                                                              // 227: CMsgGC_Match_Result.Player
	(*CMsgGC_Match_Result_EventInfo)(nil),                                                           // 228: CMsgGC_Match_Result.EventInfo
	(*CMsgGC_DailyCompetitiveStatsRollup_Response_RankBucketEntry)(nil),                             // 229: CMsgGC_DailyCompetitiveStatsRollup_Response.RankBucketEntry
	(*CMsgGCDataCenterPing_Update_PingEntry)(nil),                                                   // 230: CMsgGCDataCenterPing_Update.PingEntry
	(*CMsgGCChangeMatchPlayerTeamsRequest_Member)(nil),                                              // 231: CMsgGCChangeMatchPlayerTeamsRequest.Member
	(*CSOEconItem)(nil),                                                                             // 232: CSOEconItem
}
var file_tf_gcmessages_proto_depIdxs = []int32{
	213, // 0: CMsgGameServerData.players:type_name -> CMsgGameServerData.Player
	3,   // 1: CMsgTFWorldStatus.event_match_group:type_name -> ETFMatchGroup
	3,   // 2: CMsgTFWorldStatus.disabled_match_groups:type_name -> ETFMatchGroup
	214, // 3: CMsgTFQuickplay_ScoreServers.servers:type_name -> CMsgTFQuickplay_ScoreServers.ServerInfo
	215, // 4: CMsgTFQuickplay_ScoreServersResponse.servers:type_name -> CMsgTFQuickplay_ScoreServersResponse.ServerInfo
	11,  // 5: CMsgGC_GameServer_CreateIdentityResponse.status:type_name -> CMsgGC_GameServer_CreateIdentityResponse.EStatus
	216, // 6: CMsgGC_GameServer_ListResponse.owned_game_servers:type_name -> CMsgGC_GameServer_ListResponse.GameServerIdentity
	12,  // 7: CMsgGC_Client_UseServerModificationItem_Response.response_code:type_name -> CMsgGC_Client_UseServerModificationItem_Response.EServerModificationItemResponse
	1,   // 8: CMsgGC_GameServer_UseServerModificationItem.modification_type:type_name -> EServerModificationItemType
	1,   // 9: CMsgGC_GameServer_UseServerModificationItem_Response.modification_type:type_name -> EServerModificationItemType
	13,  // 10: CMsgGC_GameServer_UseServerModificationItem_Response.server_response_code:type_name -> CMsgGC_GameServer_UseServerModificationItem_Response.EServerModificationItemServerResponse
	1,   // 11: CMsgGC_GameServer_ServerModificationItemExpired.modification_type:type_name -> EServerModificationItemType
	1,   // 12: CMsgGC_GameServer_ServerModificationItem.modification_type:type_name -> EServerModificationItemType
	94,  // 13: CSOTFPartyMember.player_criteria:type_name -> CTFPerPlayerMatchCriteriaProto
	217, // 14: CSOTFPartyMember.activity:type_name -> CSOTFPartyMember.Activity
	14,  // 15: TFPendingPartyMember.type:type_name -> TFPendingPartyMember.EType
	2,   // 16: TFSyncedMMUIState.menu_step:type_name -> ETFSyncedMMMenuStep
	3,   // 17: TFSyncedMMUIState.match_group:type_name -> ETFMatchGroup
	93,  // 18: CTFGroupMatchCriteriaProto.casual_criteria:type_name -> CTFCasualMatchCriteria
	92,  // 19: CTFPartyOptions.group_criteria:type_name -> CTFGroupMatchCriteriaProto
	94,  // 20: CTFPartyOptions.player_criteria:type_name -> CTFPerPlayerMatchCriteriaProto
	91,  // 21: CTFPartyOptions.player_uistate:type_name -> TFSyncedMMUIState
	95,  // 22: CMsgPartySetOptions.options:type_name -> CTFPartyOptions
	95,  // 23: CMsgPartyQueueForMatch.final_options:type_name -> CTFPartyOptions
	3,   // 24: CMsgPartyQueueForMatch.match_group:type_name -> ETFMatchGroup
	3,   // 25: CMsgPartyRemoveFromQueue.match_group:type_name -> ETFMatchGroup
	15,  // 26: CMsgPartyMMError.type:type_name -> CMsgPartyMMError.Type
	4,   // 27: CMsgPartyChatMsg.type:type_name -> ETFPartyChatType
	89,  // 28: CSOTFParty.members:type_name -> CSOTFPartyMember
	3,   // 29: CSOTFParty.associated_lobby_match_group:type_name -> ETFMatchGroup
	218, // 30: CSOTFParty.matchmaking_queues:type_name -> CSOTFParty.QueueEntry
	92,  // 31: CSOTFParty.group_criteria:type_name -> CTFGroupMatchCriteriaProto
	91,  // 32: CSOTFParty.leader_ui_state:type_name -> TFSyncedMMUIState
	90,  // 33: CSOTFParty.pending_members:type_name -> TFPendingPartyMember
	219, // 34: CSOTFPartyInvite.members:type_name -> CSOTFPartyInvite.PartyMember
	16,  // 35: CSOTFPartyInvite.type:type_name -> CSOTFPartyInvite.Type
	6,   // 36: CTFLobbyPlayerProto.team:type_name -> TF_GC_TEAM
	17,  // 37: CTFLobbyPlayerProto.connect_state:type_name -> CTFLobbyPlayerProto.ConnectState
	18,  // 38: CTFLobbyPlayerProto.type:type_name -> CTFLobbyPlayerProto.Type
	3,   // 39: CTFLobbyInviteProto.match_group:type_name -> ETFMatchGroup
	119, // 40: CSOTFGameServerLobby.members:type_name -> CTFLobbyPlayerProto
	19,  // 41: CSOTFGameServerLobby.state:type_name -> CSOTFGameServerLobby.State
	5,   // 42: CSOTFGameServerLobby.game_state:type_name -> TF_GC_GameState
	20,  // 43: CSOTFGameServerLobby.is_war_match:type_name -> CSOTFGameServerLobby.WarMatch
	119, // 44: CSOTFGameServerLobby.pending_members:type_name -> CTFLobbyPlayerProto
	9,   // 45: CMsgGameServerMatchmakingStatus.matchmaking_state:type_name -> ServerMatchmakingState
	220, // 46: CMsgGameServerMatchmakingStatus.players:type_name -> CMsgGameServerMatchmakingStatus.Player
	5,   // 47: CMsgGameServerMatchmakingStatus.game_state:type_name -> TF_GC_GameState
	22,  // 48: CMsgGameServerMatchmakingStatus.event:type_name -> CMsgGameServerMatchmakingStatus.Event
	222, // 49: CMsgMvMVictoryInfo.players:type_name -> CMsgMvMVictoryInfo.Player
	223, // 50: CMsgMvMVictory.players:type_name -> CMsgMvMVictory.Player
	7,   // 51: CMsgPlayerLeftMatch.leave_reason:type_name -> TFMatchLeaveReason
	160, // 52: CMsgPlayerLeftMatch.xp_breakdown:type_name -> CMsgTFXPSource
	8,   // 53: CMsgProcessMatchVoteKick.reason:type_name -> TFVoteKickReason
	224, // 54: CMsgProcessMatchVoteKick.votes:type_name -> CMsgProcessMatchVoteKick.Vote
	225, // 55: CMsgUpdateHalloweenMerasmusLootLevel.players:type_name -> CMsgUpdateHalloweenMerasmusLootLevel.Player
	226, // 56: CGCMsgGC_War_GlobalStatsResponse.side_scores:type_name -> CGCMsgGC_War_GlobalStatsResponse.SideScore
	24,  // 57: CMsgTFXPSource.type:type_name -> CMsgTFXPSource.XPSourceType
	160, // 58: CMsgTFXPSourceBreakdown.sources:type_name -> CMsgTFXPSource
	25,  // 59: CMsgGCNotification.type:type_name -> CMsgGCNotification.NotificationType
	163, // 60: CMsgGCNotificationQueue.notifications:type_name -> CMsgGCNotification
	26,  // 61: CMsgGC_Match_Result.status:type_name -> CMsgGC_Match_Result.Status
	227, // 62: CMsgGC_Match_Result.players:type_name -> CMsgGC_Match_Result.Player
	228, // 63: CMsgGC_Match_Result.events:type_name -> CMsgGC_Match_Result.EventInfo
	232, // 64: CEconItemPreviewDataBlock.econitem:type_name -> CSOEconItem
	169, // 65: CMsgGC_Client2GCEconPreviewDataBlockResponse.iteminfo:type_name -> CEconItemPreviewDataBlock
	8,   // 66: CMsgGC_TFVoteKickPlayerRequest.reason:type_name -> TFVoteKickReason
	229, // 67: CMsgGC_DailyCompetitiveStatsRollup_Response.rankdata:type_name -> CMsgGC_DailyCompetitiveStatsRollup_Response.RankBucketEntry
	28,  // 68: CMsgGC_ReportPlayer.reason:type_name -> CMsgGC_ReportPlayer.EReason
	181, // 69: CMsgGCMatchGroupDataCenterPopulation.data_center_population:type_name -> CMsgGCDataCenterPopulation
	182, // 70: CMsgGCMatchMakerStatsResponse.matchgroup_data_center_population:type_name -> CMsgGCMatchGroupDataCenterPopulation
	3,   // 71: CMsgGCMatchHistoryLoad.match_group:type_name -> ETFMatchGroup
	230, // 72: CMsgGCDataCenterPing_Update.pingdata:type_name -> CMsgGCDataCenterPing_Update.PingEntry
	10,  // 73: CMsgGCSurveyRequest.question_type:type_name -> SurveyQuestionType
	10,  // 74: CMsgGCSurveyResponse.question_type:type_name -> SurveyQuestionType
	231, // 75: CMsgGCChangeMatchPlayerTeamsRequest.member:type_name -> CMsgGCChangeMatchPlayerTeamsRequest.Member
	195, // 76: CMsgGCQuestMap_Debug.unlock_node:type_name -> CMsgGCQuestMapUnlockNode
	163, // 77: CMsgGCToGCSendNotification.notification:type_name -> CMsgGCNotification
	3,   // 78: CSOTFPartyMember.Activity.lobby_match_group:type_name -> ETFMatchGroup
	3,   // 79: CSOTFParty.QueueEntry.match_group:type_name -> ETFMatchGroup
	21,  // 80: CMsgGameServerMatchmakingStatus.Player.connect_state:type_name -> CMsgGameServerMatchmakingStatus.PlayerConnectState
	23,  // 81: CMsgMvMVictoryInfo.Item.grant_reason:type_name -> CMsgMvMVictoryInfo.GrantReason
	221, // 82: CMsgMvMVictoryInfo.Player.items:type_name -> CMsgMvMVictoryInfo.Item
	160, // 83: CMsgGC_Match_Result.Player.xp_breakdown:type_name -> CMsgTFXPSource
	7,   // 84: CMsgGC_Match_Result.Player.leave_reason:type_name -> TFMatchLeaveReason
	27,  // 85: CMsgGC_Match_Result.EventInfo.event_type:type_name -> CMsgGC_Match_Result.EventInfo.EventType
	29,  // 86: CMsgGCDataCenterPing_Update.PingEntry.ping_status:type_name -> CMsgGCDataCenterPing_Update.Status
	6,   // 87: CMsgGCChangeMatchPlayerTeamsRequest.Member.new_team:type_name -> TF_GC_TEAM
